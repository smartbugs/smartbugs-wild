...
contract TixToken is SafeMath {
    ...
    function TixToken() {
        ...
        totalSupply = 10000000000000000000;                 // Update total supply
        name = 'Lottery Tickets';                          // Set the name for display purposes
        symbol = 'TIX';                          // Set the symbol for display purposes
