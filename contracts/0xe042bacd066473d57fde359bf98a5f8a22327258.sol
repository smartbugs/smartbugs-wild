...
contract NggaToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NggaToken() {
        ...
        name = "NggaToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NGGA";                                             // Set the symbol for display purposes (CHANGE THIS)
