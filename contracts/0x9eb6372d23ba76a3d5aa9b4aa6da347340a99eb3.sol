...
contract XXXToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function XXXToken() {
        ...
        name = "XXXToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "XXX";                                             // Set the symbol for display purposes (CHANGE THIS)
