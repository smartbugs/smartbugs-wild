...
contract chikaaaaaa is StandardToken {

    function chikaaaaaa() public { 
    ...
    */
    string public name = "chikaaaaaa";
    string public symbol = "chikaaaa";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 426780 * (10 ** decimals);
    ...
    string public DigestCode_root = "df45b2d44dfda77e6466cab2f54793bd325cf799b7eabf62e5a3c265a8c652f3";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/a727103a4751bf86e076fc47293f15fa3f5856f725928129821443a166d3db74/"; }
