...
contract AAACoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AAACoin() {
        ...
        name = "AAA";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AAA";                                             // Set the symbol for display purposes (CHANGE THIS)
