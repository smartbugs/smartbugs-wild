...
contract HUHEYhQD is StandardToken {

    function HUHEYhQD() public { 
    ...
    */
    string public name = "HUHEYhQD";
    string public symbol = "eljYmAGW";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 559300 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/7b1cd8868240b4a71651cb5758390c6463ea2f97572c274ad75bba70d700b5d9/";
    string public Note_root = "";
    string public DigestCode_root = "c49aadc343d19d138e989f2b81b7b2a4ca8dcca24b33d035b0896b730a583d7c";
    function getIssuer() public view returns(string) { return  "MueljYmAGWLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/cc2c2de672ab167d2e68c6154def962236fb6d62a32e579cd79d9cb4f324a503/"; }
