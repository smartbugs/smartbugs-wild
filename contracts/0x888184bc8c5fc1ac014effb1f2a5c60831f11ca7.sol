...
contract AZLTEST is ERC20 {
    ...
    string public constant name = "AZLTEST"; //* Token Name *//
    
    string public constant symbol = "ALT"; //* AZLTEST Symbol *//
    
    uint public constant decimals = 8; //* Number of Decimals *//
    
    uint256 public totalSupply = 1000000000000000000; //* total supply of AZLTEST *//
    
    uint256 public totalDistributed =  500000000000000000;  //* Initial AZLTEST that will give to contract creator *//
   
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for AZLTEST //
    
    uint256 public tokensPerEth = 2000000000000000; //* AZLTEST Amount per Ethereum *//
