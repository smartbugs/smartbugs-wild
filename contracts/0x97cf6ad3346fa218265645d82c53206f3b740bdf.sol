...
****************************************************************************************************************************/
    ...
    uint256 private rndGap_ = 1 seconds;         // length of ICO phase
...
//****************
    ...
    mapping (uint256 => RPdatasets.Player) public plyr_;   // (pID => data) player data
    mapping (uint256 => mapping (uint256 => RPdatasets.PlayerRounds)) public plyrRnds_;    // (pID => rID => data) player round data by player id & round id
    mapping (uint256 => mapping (bytes32 => bool)) public plyrNames_; // (pID => name => bool) list of names a player owns.  (used so you can change your display name amongst any name you own)
//****************
// ROUND DATA 
//****************
    mapping (uint256 => RPdatasets.Round) public round_;   // (rID => data) round data
    mapping (uint256 => mapping(uint256 => uint256)) public rndTmEth_;      // (rID => tID => data) eth in per team, by round id and team id
//****************
// TEAM FEE DATA 
//****************
    mapping (uint256 => RPdatasets.TeamFee) public fees_;          // (team => fees) fee distribution by team
    mapping (uint256 => RPdatasets.PotSplit) public potSplit_;     // (team => fees) pot split distribution by team
//****************
// KEY STORE
//****************
...
****************************************************************************************************************************/
        ...
        public
    {
        ...
        fees_[0] = RPdatasets.TeamFee(20, 48, 20, 10, 2);   //50% to pot, 15% to aff, 3% to com, 0% to pot swap, 0% to air drop pot
        fees_[1] = RPdatasets.TeamFee(48, 20, 20, 10, 2);   //37% to pot, 15% to aff, 3% to com, 0% to pot swap, 0% to air drop pot


        // how to split up the final pot based on which team was picked
        // (F3D, P3D)
        potSplit_[0] = RPdatasets.PotSplit(48, 2, 10, 20, 20);  //25% to winner, 25% to next round, 3% to com
        potSplit_[1] = RPdatasets.PotSplit(48, 2, 20, 10, 20);   //25% to winner, 25% to next round, 3% to com
...
****************************************************************************************************************************/
    ...
    /**
     * @dev Set emerald price
     * @param _price of emerald
     */
...
****************************************************************************************************************************/
   ...
   function keysRec(uint256 _curEth, uint256 _newEth)
	...
	/**
     * @dev calculates keys() function constant
     * @param _eth price of eth 
     * @return key constant for keys() function
     */
	...
	/**
     * @dev calculates eth() function constant
     * @param _eth price of eth
     * @return eth constant for eth() function
     */
...
****************************************************************************************************************************/
    ...
    //     emit RPevents.onPotSwapDeposit(_rID, msg.value);
    // }
...
library SafeMath {
    ...
    */
    function percent(uint256 _a, uint256 _b) 
        ...
        require(numerator > _b); // overflow. Should use SafeMath throughout if this was a real implementation. 
        
        uint256 temp = numerator / _a + 5; // proper rounding up
