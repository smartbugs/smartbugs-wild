...
contract REALEX is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function REALEX() {
        ...
        name = "REALEX";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 5;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "RLX";                                             // Set the symbol for display purposes (CHANGE THIS)
