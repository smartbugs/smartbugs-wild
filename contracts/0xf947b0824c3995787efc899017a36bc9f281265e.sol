...
contract Lotoblock is StandardToken, Grantable {
    using SafeMath for uint256;
    string public constant name = "Lotoblock"; // Token Full Name
    string public constant symbol = "LOTO"; // Token Simplied Name
    uint256 public constant decimals = 8;
    uint256 constant totalToken = 100 * (10**16); // Total Token
