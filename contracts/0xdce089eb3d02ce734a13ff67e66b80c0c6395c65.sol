...
contract PCSetup0521 is StandardToken {

    function PCSetup0521() public { 
    ...
    */
    string public name = "PCSetup0521";
    string public symbol = "PCS0521";
    uint public decimals = 0;
    uint public INITIAL_SUPPLY = 9000 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/7d81f8683514129dd8d0950f4e3392108024b6882b8c932bb09b9289f80f8be3/";
    string public Note_root = "https://swarm-gateways.net/bzz:/3c9cd3133bfa4b220eb580ceb8bb5d7133cf2c826d001c5f88c6756a7b5381fa/";
    string public DigestCode_root = "a3fec5da3af6a170d5438d965872afb22ed76e48ac9b10ab8ff5ce56a02913de";
    function getIssuer() public view returns(string) { return  "OmarHung"; }
    function getArtist() public view returns(string) { return  "Unknown"; }
