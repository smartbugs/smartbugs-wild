...
contract CashTCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CashTCoin() {
        ...
        name = "CashTCoin";                                          // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CSTC";                                             // Set the symbol for display purposes (CHANGE THIS)
