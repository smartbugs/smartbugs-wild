...
/*
    ...
    This contract is deployed as a short term solution to replace the broken contract at
    0xc88b6573cC09FD48FFaD73a9E09A0B3A93F095Be
*/

/// @title OneTimeListingManager Contract
...
contract OneTimeListingManager is Ownable {
    ...
    address public constant DUD_EVT = 0x9EdCf4f838Ed4f2A05085Bd3d67ADFdE5620d940;
    ...
    function startTokenVotes(address[] memory _tokens, uint _duration, uint _criteria, uint _extraData) public onlyAdmins {
        ...
        p.startTime = 1553596261 + (1209600 / 2); // Hardcoded to match old token
