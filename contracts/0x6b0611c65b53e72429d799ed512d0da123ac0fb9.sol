...
contract JapaneseAVCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function JapaneseAVCoin() {
        ...
        name = "JapaneseAVCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "JAV";                                             // Set the symbol for display purposes (CHANGE THIS)
