...
////////////////////////////////////////////////////////////////////////////////
//
// Eth17 - Factory Contract
//
////////////////////////////////////////////////////////////////////////////////

// IMPORTS - now flattened for Etherscan verification
...
////////////////////////////////////////////////////////////////////////////////
// Eth17 - Factory Contract - generates the game contracts
////////////////////////////////////////////////////////////////////////////////
    ...
    constructor() public payable {
        ...
        ////////////////////////////////////////////////////////////////////////
        // SET MASTER PRIOR TO FACTORY DEPLOYMENT
        //
...
//    function setMasterAddress(address _address) onlyAdmin public {
...
//    }
    ...
    function transferEth() public {
        ...
        // pull eth from master address contract if this contract is empty
        master.transferEth();
        }
    }
    
    // transfer Eth but retain 1 eth (nobody guessed correctly)
...
contract Eth17 is usingOraclize {       
    ...
    // private number (public for testing)
    uint private random;
    ...
    // Note: The maximum amount in the contract can be 1.5875 eth (inc. the seeded 1 eth)
    // The 17th guesser automatically gets their eth refunded in the event 
    // of an incorrect guess (0.1 eth)
    // The Devs claim 0.2875 per game if all guesses are unsuccessful 
    // therefore each subsequent game will grow by 0.2 eth
    ...
    function startNewGameError() public {
        ...
        require (nextGuess == 1);
        mutex = true;
        // spawn another new contract because this contract 
        // did not contain a random number
    ...
    function guessNumber(uint _guess) public payable {
        ...
        // if nobody guesses correctly in 17 guesses
        if (nextGuess == 17) {
            require (msg.value == costOfNextGuess());
            lastGuessAddress = msg.sender;
            address(msg.sender).transfer(guess17);              // amount refunded
            address(devWallet).transfer(0.2875 ether);
            address(admin).transfer(address(this).balance);     // remainder sent to master 
            nextGuess ++;
            showRandomNumber();
            spawnNewContractSeventeenGuesses();
            mutex = false;   
        ...
        // if there have been less than 17 guesses
...
//
    ...
    { 
        ...
        if (oraclize_randomDS_proofVerify__returnCode(_queryId, _result, _proof) != 0) {
            ...
            random = uint(sha3(_result)) % maxRange; // this is an efficient way to get the uint out in the [0, maxRange] range
   ...
   function spawnNewContract() public {
    ...
    function showRandomNumber() public {
        require (
            // All 17 guesses used
            nextGuess == 18 || 
            // Somone guessed correctly
            guessedCorrectly == true || 
            // game finished and at least one guess was made
            (now > gameEnd && nextGuess > 1)
            ); 
        
        //expose the private random number
        makeRandomPublic();
    }
    
    function makeRandomPublic() private {
        // copy the private number to the public uint
        randomPublic = random;                  
    }
