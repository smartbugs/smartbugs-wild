...
// https://github.com/OpenZeppelin/openzeppelin-solidity/blob/master/contracts/token/ERC20/ERC20Pausable.sol
...
contract Frethan is ERC20Detailed, ERC20, ERC20Mintable, ERC20Burnable, ERC20Capped, ERC20Pausable {
    ...
    // Contract Details
    uint8 private constant _DECIMALS = 18;                      // Standard - Best not to change
    string private constant _NAME = "Frethan";                  // Frethan - Name always
    string private constant _SYMBOL = "FAE";                    // FAE - Sybmbol for Live Network
    uint256 private constant _SUPPLY = 10000000000;             // 10 Billion

    // Calculate Intial Supply
    uint256 public initialSupply = _SUPPLY * (10 ** uint256(_DECIMALS));

    // Variables for Contract Details
    string public name;
