...
contract Conserve is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Conserve() {
        ...
        name = "Conserve";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBI";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 250000000;                                      // Set the price of your token for the ICO (CHANGE THIS)
