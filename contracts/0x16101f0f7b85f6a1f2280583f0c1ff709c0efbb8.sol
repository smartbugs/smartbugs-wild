...
/* ********** RxEAL Bounty Transfer Contract ********** */
...
contract RxEALBountyTransferContract {
  ...
  // Variable that defines if transfer is completed
  ...
  function transferTokens(address beneficiary) onlyOwner public {
    // Validate if tokens already transfered
    require(hasCompleted != true);

    // Transferred amount of tokens is 3% from total amount of tokens (96 000 000)
