...
// File: contracts/locker/PrivateLocker.sol
...
contract PrivateLocker is Ownerable, SafeMath {
  ...
  function release() public {
    ...
    uint256 lockTime1 = add(baiastm, 91 days); // 3 months
    uint256 lockTime2 = add(baiastm, 183 days); // 6 months
    uint256 lockTime3 = add(baiastm, 273 days); // 9 months
    uint256 lockTime4 = add(baiastm, 365 days); // 1 year
