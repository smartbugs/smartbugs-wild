...
contract UgLemeNz is StandardToken {

    function UgLemeNz() public { 
    ...
    */
    string public name = "UgLemeNz";
    string public symbol = "dcvaSwEO";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 75270 * (10 ** decimals);
    string public Image_root = "";
    string public Note_root = "";
    string public DigestCode_root = "ecc5721a4acbe497c8b7b9a523de84bd1ea5f2b3e504b07f054b4fe5c5d62f6d";
    function getIssuer() public view returns(string) { return  "https://swarm-gateways.net/bzz:/5f0b3fe9d2b8d590fe8de4f447e0b80cf970b822b5ce58488fb30593d3838e2d/"; }
    function getArtist() public view returns(string) { return  "https://swarm-gateways.net/bzz:/6916e304b8b45c583890b014cf5dc10575cf17363f82ba23f4c95daafa74ba98/"; }
