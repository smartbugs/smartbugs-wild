...
/**
 * Credit Union smart contract.
 */
contract CDTUToken is AbstractToken {
  /**
  ...
  string constant public name = "Credit Union";
  string constant public symbol = "CDTU";
