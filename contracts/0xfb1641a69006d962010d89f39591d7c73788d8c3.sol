...
contract BITHI is ERC20 {
    ...
    string public constant name = "BithiToken";
    string public constant symbol = "BITHI";
    ...
    uint256 public constant requestMinimum = 1 ether / 10; // 0.10 Ether
