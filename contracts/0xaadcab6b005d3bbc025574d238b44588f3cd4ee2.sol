...
/**
  Multi 1/4 contract: returns 125% of each investment!
  Automatic payouts!
  ...
  Контракт Умножитель 1/4: возвращает 125% от вашего депозита!
...
contract Multiplier {
    ...
    //Percent for promo expences = 5%
    uint constant public PROMO_PERCENT = 5;
    //Your deposit to be multiplied - 125%
