...
contract GucciCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GucciCoin() {
        ...
        name = "GUCCICOIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GUC";                                             // Set the symbol for display purposes (CHANGE THIS)
