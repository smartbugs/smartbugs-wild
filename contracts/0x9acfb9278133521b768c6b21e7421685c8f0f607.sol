...
contract HongBaoToken is MintableToken {

  string public constant name = "Crypto HongBao"; // solium-disable-line uppercase
  string public constant symbol = "HBO"; // solium-disable-line uppercase
