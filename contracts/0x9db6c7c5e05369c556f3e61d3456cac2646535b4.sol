...
contract TCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TCoin() {
        ...
        name = "TCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TTCN";                                             // Set the symbol for display purposes (CHANGE THIS)
