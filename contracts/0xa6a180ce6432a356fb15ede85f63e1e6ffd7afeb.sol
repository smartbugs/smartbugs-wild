...
contract VeteranCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function VeteranCoin() {
        ...
        name = "VeteranCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "XVC";                                             // Set the symbol for display purposes (CHANGE THIS)
