...
contract EfectiveToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EfectiveToken() {
        ...
        name = "EfectiveToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "EFT";                                             // Set the symbol for display purposes (CHANGE THIS)
