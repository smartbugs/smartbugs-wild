...
/**
 * @title ClarityStandard
 * @dev the interface of Clarity
 */
...
contract Clarity is ERC20,ClarityStandard,Ownable {
    ...
    uint public stakeMinAge = 2 days; // minimum age for coin age: 3D
    uint public stakeMaxAge = 45 days; // stake age of full weight: 90D
