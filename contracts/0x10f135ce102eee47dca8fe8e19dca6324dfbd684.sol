...
contract TCDC is owned, SafeMath {
    ...
    uint constant valueTotal = 2 * 10000 * 10000 * 10 ** 8;	//A total of two hundred million
    uint constant valueSale = valueTotal / 100 * 50;  // sell 50%
    uint constant valueTeam = valueTotal / 100 * 50;   // team 50%
