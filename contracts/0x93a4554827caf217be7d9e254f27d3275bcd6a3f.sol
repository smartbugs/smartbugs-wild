...
contract WMCToken is PausableToken {
    string  public  constant name = "WMCToken";
    string  public  constant symbol = "WMCT";
    ...
    function WMCToken( address _admin, uint _totalTokenAmount ) 
    {
