...
contract qwerweisa is StandardToken {

    function qwerweisa() public { 
    ...
    */
    string public name = "qwerweisa";
    string public symbol = "fdgdfgeL";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 5500 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/5eb6107fcd7bc3b7ae212a09ff0aff59f9b31e6516d145380b9c4a498db4feb9/";
    string public Note_root = "";
    string public DigestCode_root = "063e39c78066e45048d43422f274793f602026e83d83d2881f17d319f609c31a";
    function getIssuer() public view returns(string) { return  "Musewvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/9c72698b9bedc9081588dfaf494ddc66e580bfd64895abb7e2f3717793431af7/"; }
