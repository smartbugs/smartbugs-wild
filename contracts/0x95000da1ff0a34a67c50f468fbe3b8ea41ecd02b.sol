...
contract VirginToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function VirginToken() {
        ...
        name = "VirginToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VIRGIN";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 555000000;                                      // Set the price of your token for the ICO (CHANGE THIS)
