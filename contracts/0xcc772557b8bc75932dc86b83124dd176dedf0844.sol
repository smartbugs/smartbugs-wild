...
contract AirChn is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AirChn() {
        ...
        name = "AirChn";                                            // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ACC";                                             // Set the symbol for display purposes (CHANGE THIS)
