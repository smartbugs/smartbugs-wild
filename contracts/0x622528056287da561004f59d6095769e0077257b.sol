...
contract AcademiCon is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AcademiCon() {
        ...
        name = "AcademiCon";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ADC";                                             // Set the symbol for display purposes (CHANGE THIS)
