...
contract MoonStone is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MoonStone() {
        ...
        name = "MoonStone";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MSTN";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 4322;                                      // Set the price of your token for the ICO (CHANGE THIS)
