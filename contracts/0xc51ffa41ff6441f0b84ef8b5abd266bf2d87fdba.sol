...
contract MasterToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MasterToken() {
        ...
        name = "MasterToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MSTR";                                             // Set the symbol for display purposes (CHANGE THIS)
