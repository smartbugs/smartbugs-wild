...
contract Humanity is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Humanity() {
        ...
        name = "Humanity";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HMTY";                                             // Set the symbol for display purposes (CHANGE THIS)
