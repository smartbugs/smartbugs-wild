...
contract Castor is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Castor() {
        ...
        name = "Castor";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CSTR";                                             // Set the symbol for display purposes (CHANGE THIS)
