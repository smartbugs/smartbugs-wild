...
library SafeMath {
  ...
  */
  ...
  /**
  * @dev Integer division of two number
[2] only remix transactions, script

Search transactions

Listen on networks, truncating the quotient.
  */
...
// File: contracts/AhmadToken.sol

contract ahmadToken is CappedToken, BurnableToken, OwnerContract, DisableSelfTransfer {
    string public name = "ahmad Token";
