...
/**
 * @title srOwnable
 * @dev The srOwnable contract has an owner address, and provides basic authorization control
 * functions, this simplifies the implementation of "user permissions".
 */
...
contract srToken is StandardToken, srPausable, srOwnable {
  ...
  /**
   * @dev Allows transfers only when contract is not paused.
   * @param _to address The address which you want to transfer to
  ...
  /**
   * @dev Allows owner to transfer tokens from one address to another.
   * @param _from address The address which you want to send tokens from
   * @param _to address The address which you want to transfer to
   * @param _value uint256 the amout of tokens to be transfered
   */
