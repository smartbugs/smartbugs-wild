...
contract SaintCoinWorld is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SaintCoinWorld() {
        ...
        name = "SaintCoinWorld";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SNTW";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 6000;                                   // Set the price of your token for the ICO (CHANGE THIS)
