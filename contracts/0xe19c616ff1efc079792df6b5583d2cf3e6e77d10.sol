...
contract FoMo3Dlong is modularLong {
    ...
    address private otherF3D_ = 0x6ccAb77AC0A2a7665E84f2B84b44Ca31beB435eB; // 慈善基金
    address constant private reward = 0x03164e242C8CBD528a1400B805d796Df02E13544; // 团队基金
    address constant private deployer = 0xDb9396B9c7D639b7B79C33f1d100F78E042e725f; // 开发者
        ...
        public
    {
        ...
        // X.FLY HACK gen 意思改为玩家分配比例，p3d 意思改为奖池分配比例
     ...
     * been activated. these are safety checks
     */
...
//==============================================================================
        ...
        returns (F3Ddatasets.EventReturns)
    {
        ...
        // calculate our winner share, community rewards, gen share, amount reserved for next pot 
        // X.FLY HACK
        // gen 意思变为赢家分配比例，p3d 意思变为下一轮分配比例，
        // 移除其他分配
        ...
        returns(F3Ddatasets.EventReturns)
    {
        ...
        // X.FLY HACK
        // 这里的 14 就是 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
