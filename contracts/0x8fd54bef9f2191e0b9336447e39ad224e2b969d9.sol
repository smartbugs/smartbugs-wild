...
contract AK47Coin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AK47Coin() {
        ...
        name = "AK47Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 9;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AK47";                                             // Set the symbol for display purposes (CHANGE THIS)
