...
contract TheBigChillCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TheBigChillCoin() {
        ...
        name = "TheBigChillCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TBC";                                             // Set the symbol for display purposes (CHANGE THIS)
