...
/**
 * @title VeloxToken
 * @dev VeloxCoin is now the VeloxToken ERC20 token contract.
 * This VeloxToken update removes staking in favor of lower gas fees and updates Solditiy to 0.5.0.
 */
