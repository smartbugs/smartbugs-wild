...
* [✓] 20% rewards for token purchase, shared among all token holders.
* [✓] 10% rewards for token transfer, shared among all token holders.
* [✓] 25% rewards for token selling.
* [✓] 15% of the total purchase each time someone uses your Masternode.
