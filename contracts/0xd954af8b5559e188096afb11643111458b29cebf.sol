...
/*
* Poexer.com is a real-time decentralized cryptocurrency exchange which allows you to trade Ethereum with POEX tokens.
* Buy, Sell, or Transfer POEX tokens, fees of your transaction is used to pay earnings to other users holding POEX tokens.
* - The fee for Buying: 1%
* - The fee for Selling: 2%
...
* Invite your friends to trade on Poexer.com, and you will receive up to 25% of the buy-in-fees they would otherwise pay to the contract, in ETH, in real-time!
...
contract POEXToken {
    ...
    */
        ...
        returns(uint256)
    {
        ...
        // referral commission rewards to 25% for address that hold 500 POEX or more
