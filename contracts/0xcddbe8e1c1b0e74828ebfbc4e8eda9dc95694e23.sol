...
contract InnateToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function InnateToken() {
        ...
        name = "InnateToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ITKN";                                             // Set the symbol for display purposes (CHANGE THIS)
