...
contract QuestionnaireConnect is StandardToken, Ownable {

    string  public  constant name = "Questionnaire Connect";
    string  public  constant symbol = "QC";
    uint    public  constant decimals = 18;

    function QuestionnaireConnect( uint tokenTotalAmount){
