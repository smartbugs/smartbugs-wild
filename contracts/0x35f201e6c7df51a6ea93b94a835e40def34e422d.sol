...
contract ExBike is StandardToken {

    function ExBike() public { 
    ...
    */
    string public name = "ExBike";
    string public symbol = "EB";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 15000 * (10 ** decimals);
    string public Image_root = "https://swarm.chainbacon.com/bzz:/a32e6037b56845e77d5cb4ed53c5db9d6ff13597db1f9c7d059746c61570020e/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/a4b54b3d22f492fd3fa2dca165bf94af382f18eb976ccad587e4567031a23cf5/";
    string public DigestCode_root = "c79e553df3b3bc0b50f9164c209b106dd7993ab06315cb9757a05eb31e702d0a";
    function getIssuer() public view returns(string) { return  "Someone"; }
    function getSource() public view returns(string) { return  "VisualHnt"; }
