...
string public constant _myTokeName = 'Xenyx Token';//change here
string public constant _mySymbol = 'XYX';//change here
uint public constant _myinitialSupply = 1000000000;//leave it
