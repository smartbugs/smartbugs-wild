...
* [x] Masternodes: Holding 100 POWER Tokens allow you to generate a Masternode link, Masternode links are used as unique entry points to the contract!
...
* [x] Longevity: We have something no other program has to offer.  We have big plans to moon this and provide lasting dividends so come along for the ride!
*/
...
contract Power {
    ...
    */
    function Power()
        public
    {
        // add administrators here, we don't need no stinking admins
        
        // add the ambassadors here, or don't, power to the people
