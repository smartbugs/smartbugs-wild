...
/**
 * The Intelligent Shipping Chain token (ETYC - ETYCToken) has a fixed supply
 *
...
contract ETYCToken is StandardToken, BurnableToken, Ownable {
     ...
     *
     * @param _value    The amount of tokens to burn in wei-ETYC
     */
    function burn(uint256 _value) public {
...
/**
 * The ETYCSale smart contract is used for selling ETYC tokens (ETYC).
...
contract ETYCSale is Pausable {
     ...
     * @param rateEtycToEther                the conversion rate from ETYC to Ether
     ...
     * are in units of wei and mini-ETYC. Every digit counts.
     *
     * @param _to            the recipient of the tokens
     * @param amountWei     the amount contributed in wei
     * @param amountMiniEtyc the amount of tokens transferred in mini-ETYC (18 decimals)
     */
    ...
    */
    ...
    /**
     * Given an amount in ETYC, this method returns the equivalent amount
     * in mini-ETYC.
     *
     * @param amount    an amount expressed in units of ETYC
     */
