...
contract LongStandardToken is StandardToken { 
    ...
    function LongStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
