...
/**
  Easy Multiplier contract: returns 125% of each investment! LESS ADV% - MORE PAYOUT!
  Automatic payouts!
...
/**
  Easy Multiplier : возвращает 125% от вашего депозита! МЕНЬШЕ НА РЕКЛАМУ - БОЛЬШЕ НА ВЫПЛАТЫ!
...
contract EasyMultiplier {
    ...
    uint constant public PROMO_PERCENT = 1; //1% for advertizing
