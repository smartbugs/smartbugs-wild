...
contract PANX is ERC20, Ownable {
  string public constant name = "PanterX";
  string public constant symbol = "PANX";
  uint32 public constant decimals = 0;

  uint256 private _totalSupplyPANX = 1e9;
  ...
  function activateSaleContract(address crowdsale) public onlyOwner {
    ...
    _mint(crowdsaleAddress, _totalSupplyPANX);
    emit CrowdsaleActivation(crowdsaleAddress, _totalSupplyPANX);
  }
}