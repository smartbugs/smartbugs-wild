...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'DigiStakes';//change here
    string public constant _mySymbol = 'DIGI';//change here
    uint public constant _myinitialSupply = 200000000000000;//leave it
    uint8 public constant _myDecimal = 2;//leave it
...
contract MyAdvancedToken is CAPS, CCXTokenERC20 {
