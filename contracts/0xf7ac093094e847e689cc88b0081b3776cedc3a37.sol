...
contract MicroBitCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MicroBitCoin() {
        ...
        name = "Micro Bit Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MBCT";                                             // Set the symbol for display purposes (CHANGE THIS)
