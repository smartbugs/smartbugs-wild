...
contract AUTSCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AUTSCoin() {
        ...
        name = "AUTS";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AUTS";                                             // Set the symbol for display purposes (CHANGE THIS)
