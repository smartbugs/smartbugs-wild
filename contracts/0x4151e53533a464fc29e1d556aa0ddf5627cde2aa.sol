...
contract BatakToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BatakToken() {
        ...
        name = "BatakToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTK";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 1500;                                      // Set the price of your token for the ICO (CHANGE THIS)
