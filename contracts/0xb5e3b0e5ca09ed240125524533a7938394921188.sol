 ...
 *
 */
contract GamityBountyToken is StandardToken, Pausable {

  string public constant name = 'GamityBounty';                       // Set the token name for display
  string public constant symbol = 'GMT';                                       // Set the token symbol for display
  uint8 public constant decimals = 8;                                          // Set the number of decimals for display
  uint256 public constant INITIAL_SUPPLY = 150000 * 10**uint256(decimals); // 500000 GMT specified in Grains

  /**
   * @dev GamityBountyToken Constructor
