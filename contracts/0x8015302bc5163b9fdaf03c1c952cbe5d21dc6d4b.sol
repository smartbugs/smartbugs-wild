...
contract Airsavecoin is StandardToken { // CHANGE THIS. Update the contract name.
...
*************A I R S A V E C O I N ****************A I R S A V E C O I N  
   */
    ...
    uint256 public Airsavecoin ;     // How many units of your coin can be bought by 1 ETH?
    ...
    function Airsavecoin() {
        ...
        name = "Airsavecoin";                                   // Set the name for display purposes (A I R S A V E C O I N )
        decimals = 0;                                               // Amount of decimals for display purposes (A I R S A V E C O I N )
        symbol = "AST";                                             // Set the symbol for display purposes (A I R S A V E C O I N )
