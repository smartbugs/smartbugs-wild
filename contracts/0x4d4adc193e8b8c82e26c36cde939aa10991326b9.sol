...
// TEAM FEE DATA 
//****************
    uint256 public fees_ = 50;          // fee distribution
...
//==============================================================================
    ...
    /**
     * @dev prevents contracts from interacting with GoalbonanzaPlus 
     */
    modifier isHuman() {
...
//=====_|=======================================================================
        ...
        returns(uint256, uint256, uint256, uint256, uint256, address, bytes32, uint256)
    {
        ...
        (
            ...
            round_[_rID].strt,              //2
            round_[_rID].pot,               //3
            (round_[_rID].plyr * 10),     //6 check here
            plyr_[round_[_rID].plyr].addr,  //5
            plyr_[round_[_rID].plyr].name,  //6
...
//==============================================================================
    ...
    {
        uint256 _pID = pIDxAddr_[msg.sender];
        // if player is new to this version of GoalbonanzaPlus
        if (_pID == 0)
        {
        ...
        returns(RSdatasets.EventReturns)
    {
        ...
        if (!address(TeamGoalbonanza).call.value(_com)(bytes4(keccak256("deposit()"))))
        {
            // This ensures TeamGoalbonanza cannot influence the outcome
