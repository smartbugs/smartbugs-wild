...
contract LightningInternetTechnologies is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LightningInternetTechnologies() {
        ...
        name = "LightningInternetTechnologies";                                   // Set the name for display purposes (CHANGE THIS)
