...
* Web              - https://ether3.io
* Twitter          - https://twitter.com/ether3_io
* Telegram_channel - https://t.me/ether3
* EN  Telegram_chat: https://t.me/ether3_chat_en
* Email:             mailto:support(at sign)ether3.io
*
*
*  - GAIN 3% - 1% PER 24 HOURS (interest is charges in equal parts every 10 min)
*  - Life-long payments
...
*
* ---How to use:
*  1. Send from ETH wallet to the smart contract address 0xA7B3b4a2a2C7E7a32319E4D1c455B96ebDaFf9c9
...
*
* ---Refferral system:
*     from 0 to 10.000 ethers in the fund - remuneration to each contributor is 3%,
...
*
* Main contract - Ether3. Scroll down to find it.
*/
...
contract Ether3 is Accessibility {
    ...
    uint public constant maxBalance = 300e5 ether; // 30 000 000 eth
    ...
    Percent.percent private m_advertisingPercent = Percent.percent(7, 100);  //   7/100  *100% = 7%
    ...
    function dailyPercent() internal view returns(Percent.percent memory p) {
        ...
        // (3) 3% if balance < 1 000 ETH
        // (2) 2% if 1 000 ETH <= balance <= 30 000 ETH
        // (1) 1% if 30 000 ETH < balance
