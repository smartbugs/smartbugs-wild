pragma solidity ^0.4.24;
 ...
 // Zaynix Website: https://zaynix.com
 // Zaynix Coin: https://zaynix.com/exchange
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//=================_|===========================================================
    ...
    uint256 private rndInit_ = 25 hours;                // round timer starts at this
    uint256 constant private rndInc_ = 300 seconds;              // every full key purchased adds this much to the timer
    uint256 private rndMax_ = 72 hours;                          // max length a round timer can be
...
//****************
    ...
    mapping (uint256 => ZaynixKeyDatasets.Player) public plyr_;   // (pID => data) player data
    mapping (uint256 => mapping (uint256 => ZaynixKeyDatasets.PlayerRounds)) public plyrRnds_;    // (pID => rID => data) player round data by player id & round id
    mapping (uint256 => mapping (bytes32 => bool)) public plyrNames_; // (pID => name => bool) list of names a player owns.  (used so you can change your display name amongst any name you own)
//****************
// ROUND DATA
//****************
    mapping (uint256 => ZaynixKeyDatasets.Round) public round_;   // (rID => data) round data
    mapping (uint256 => mapping(uint256 => uint256)) public rndTmEth_;      // (rID => tID => data) eth in per team, by round id and team id
//****************
// TEAM FEE DATA
//****************
    mapping (uint256 => ZaynixKeyDatasets.TeamFee) public fees_;          // (team => fees) fee distribution by team
    mapping (uint256 => ZaynixKeyDatasets.PotSplit) public potSplit_;     // (team => fees) pot split distribution by team
//==============================================================================
...
//==============================================================================
        ...
        public
    {
        ...
        //no teams... only ZaynixKey-heads
        // Referrals / Community rewards are mathematically designed to come from the winner's share of the pot.
        fees_[0] = ZaynixKeyDatasets.TeamFee(49,10);   //30% to pot, 10% to aff, 1% to dev,
       

        potSplit_[0] = ZaynixKeyDatasets.PotSplit(15,10);  //48% to winner, 25% to next round, 2% to dev
    }
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
...
//==============================================================================
    ...
    /**
     * @dev distributes eth based on fees to com, aff, and ZaynixKey
     */
        ...
        returns(ZaynixKeyDatasets.EventReturns)
    {
        ...
        if (_ZaynixKey > 0)
        {
            ...
            //uint256 _potAmount = _ZaynixKey / 2;
...
library ZaynixKeyDatasets {
    ...
    struct EventReturns {
        ...
        uint256 ZaynixKeyAmount;          // amount distributed to p3d
    ...
    struct TeamFee {
        ...
        uint256 ZaynixKey;    // % of buy in thats paid to ZaynixKey holders
    }
    struct PotSplit {
        uint256 gen;    // % of pot thats paid to key holders of current round
        uint256 ZaynixKey;    // % of pot thats paid to ZaynixKey holders
    }
}
