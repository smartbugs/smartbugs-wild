...
contract MidasDiscountToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MidasDiscountToken() {
        ...
        name = "MidasDiscountToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MDX";                                             // Set the symbol for display purposes (CHANGE THIS)
