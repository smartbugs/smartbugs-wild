...
contract ARCoin is StandardToken {
    ...
    */
    string public name = 'ARCoin';                	//fancy name: eg Simon Bucks
    ...
    string public symbol = 'ARX';                 	//An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ARCoin(
        ...
        name = "ARCoin";                       // Set the name for display purposes
        decimals = 4;                           // Amount of decimals for display purposes
        symbol = "ARX";                         // Set the symbol for display purposes
    }
