...
/**
  ...
  Web: http://gaswars.online
  Telegram: https://t.me/GasWarsETH

  GasWars contract: returns 120% of each investment!
...
/**
  ...
  Контракт GasWars: возвращает 120% от вашего депозита!
...
(полная выплата) инвестор1   <-|                   инвестор2   <----|  (доплата до 120%)
    ...
    Профит: 120%
    Минимальный вклад: 0.01 ETH
    Максимальный вклад: 5 ETH
