...
contract VitalSkin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function VitalSkin() {
        ...
        name = "VitalSkin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VTSK";                                             // Set the symbol for display purposes (CHANGE THIS)
