...
/**
 * @title GOLDEN ALLIANCE COIN Network Token
 ...
 *
 * 1 GDA is equivalent to:
 *   100000000 == 1 * 10**8 == 1e8 == One Hundred Million Grains
 *
 * 1 Billion GDA (total supply) is equivalent to:
 *   100000000000000000 == 1000000000 * 10**8 == 1e17 == One Hundred Quadrillion Grains
 *
 * All initial GDA Grains are assigned to the creator of
 * this contract.
 *
 */
contract GoldenAllianceCoin is StandardToken, Pausable {
  ...
  /**
   * @dev GoldenAllianceCoin Constructor
