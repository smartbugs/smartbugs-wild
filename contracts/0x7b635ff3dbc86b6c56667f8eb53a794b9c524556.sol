...
contract MXAContract is PausableToken {
    ...
    constructor() public {
        ...
        balances[community] = totalSupply_ * 30 / 100;				//社区生态 30%
        balances[team] = totalSupply_ * 20 / 100;					//团队 20%
        balances[foundation] = totalSupply_ * 20 / 100;				//基金会 20%
