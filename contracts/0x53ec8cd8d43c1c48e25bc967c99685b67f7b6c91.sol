...
contract Vibranium is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Vibranium() {
        ...
        name = "VibraniumProtocolNetwork";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VPN";                                             // Set the symbol for display purposes (CHANGE THIS)
