...
contract CCEAToken is PausableToken {
    string  public  constant name = "Chinese Business World";
    string  public  constant symbol = "CCEA";
    ...
    function CCEAToken( address _admin, uint _totalTokenAmount ) 
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to CCEA
