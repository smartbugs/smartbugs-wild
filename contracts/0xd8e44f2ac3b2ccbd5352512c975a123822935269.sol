...
contract FishCionBate is StandardToken {

    function FishCionBate() public { 
    ...
    */
    string public name = "FishCionBate";
    string public symbol = "FCB";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 5210 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/deb4f041ad9cac1b30517e25bc536e5516a71453cfeeeb36685bba6dd6c418cc/";
    string public Note_root = "https://swarm-gateways.net/bzz:/4560a3fc4e4fe2509867d7587aec8661b5e4c28a78c9f07d8fae54b511052412/";
    string public DigestCode_root = "ba1b989232d8354a3161d27186e387b3a9a59bfe734fd8ff6e0feb8931223194";
    function getIssuer() public view returns(string) { return  "fisher"; }
    function getArtist() public view returns(string) { return  "fisherman"; }
