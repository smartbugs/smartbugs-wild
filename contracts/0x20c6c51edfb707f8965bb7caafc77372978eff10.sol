...
/*
* BlvckMoneySteeze presents..
* ====================================*
* ⓅⓄⓈⓂ
* “PROOF OF SHEEP MENTALITIES”
* Some people are sheep, some are herders, and others are WOLVES
* Which are you?
* ====================================*
* -> What?
* The original autonomous PROOF contract, improved:
* [x] More stable than ever, having withstood severe testnet abuse and attack attempts from THEIR community!.
* [x] Audited, tested, and approved by DE FACTO.
* [X] SAME functionality; you can perform partial sell orders. If you succumb to WOLVES, you don't have to kill all the SHEEP!
* [x] SAME functionality; you can transfer tokens between wallets. Trading is possible from within the contract!
* [x] SAME Features but BETTER: PoS MasterWOLF! The NEXT implementation of Ethereum Staking in the world! Mantso is mad.
* [x] MasterWOLF: Holding ANY POSM Tokens allows you to generate a MasterWOLF link, MasterWOLF links are used as unique entry points to the contract!
* [x] MasterWOLF: All players who enter the contract through your MasterWOLF link will have 80% of their 10% dividends fee rerouted from the masterWOLF, to the WOLF-master!
* [x] INSANE protection from whales - Other contracts have promised this but whales still took over. Well NOW you wanna read the contract don’t you?
*
...
* - Anonymous Helpers (Solidity Devs)
...
contract ProofOfSheepM {
    ...
    modifier limitQuota(uint256 _amountOfEthereum){
        ...
        if((totalEthereumBalance() - _amountOfEthereum) <= quota_ ){
            require(
                // does the customer purchase exceed the max quota?
    ...
    */
    ...
    /**
     * In case the ambassador quota is not met, the administrator can manually disable the ambassador phase. (NOW OBSOLETE)
     */
    ...
    /**
     * Precautionary measures in case we need to adjust the masternode rate. (FAT CHANCE)
     */
