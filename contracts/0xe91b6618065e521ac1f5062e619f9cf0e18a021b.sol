...
contract KappyKoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KappyKoin() {
        ...
        name = "Kappy Koin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KAPK";                                             // Set the symbol for display purposes (CHANGE THIS)
