...
contract DeadmanProtocolTokens is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DeadmanProtocolTokens() {
        ...
        name = "DeadmanProtocolTokens";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DPT";                                             // Set the symbol for display purposes (CHANGE THIS)
