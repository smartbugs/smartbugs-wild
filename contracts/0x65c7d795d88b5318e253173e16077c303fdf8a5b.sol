...
contract BarclaysCertifiedDepositSubsidiaries is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function BarclaysCertifiedDepositSubsidiaries() {
        ...
        name = "Barclays Certified Deposit -Subsidiaries: Barclaycard, Barclays Bank Delaware";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GB.Pounds";                                             // Set the symbol for display purposes (CHANGE THIS)
