...
contract CoXxMoXx is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CoXxMoXx() {
        ...
        name = "CoXxMoXx";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CMX";                                             // Set the symbol for display purposes (CHANGE THIS)
