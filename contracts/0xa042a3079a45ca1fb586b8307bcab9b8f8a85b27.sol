...
contract GameMarketToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GameMarketToken() {
        ...
        name = " GameMarketToken";                         // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                      // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "T4GM";                                   // Set the symbol for display purposes (CHANGE THIS)
