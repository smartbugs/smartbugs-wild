...
//=================_|===========================================================
    ...
    uint256 constant private rndMax_ = 999 years;              // max length a round timer can be
//==============================================================================
//     _| _ _|_ _    _ _ _|_    _   .
...
//==============================================================================
        ...
        public
    {
        ...
        fees_[0] = F3Ddatasets.TeamFee(20,0);   //66% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[1] = F3Ddatasets.TeamFee(43,0);   //43% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[2] = F3Ddatasets.TeamFee(52,0);   //34% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[3] = F3Ddatasets.TeamFee(43,0);   //43% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        
        // how to split up the final pot based on which team was picked
        // (F3D, P3D)
        potSplit_[0] = F3Ddatasets.PotSplit(30,0);  //48% to winner, 20% to next round, 2% to com
        potSplit_[1] = F3Ddatasets.PotSplit(20,0);  //48% to winner, 30% to next round, 2% to com
        potSplit_[2] = F3Ddatasets.PotSplit(10,0);  //48% to winner, 40% to next round, 2% to com
        potSplit_[3] = F3Ddatasets.PotSplit(20,0);  //48% to winner, 30% to next round, 2% to com
	}
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
