...
contract Grandma is StandardToken {
    ...
    */
    string public name = "Grandma";
    string public symbol = "GM";
    uint public decimals = 0;
    uint public INITIAL_SUPPLY = 10 * (10 ** decimals);
    string public Image_root = "";
    string public Note_root = "";
    string public DigestCode_root = "4c9a053e760c6810a4cc0a97dbefb2b1b2eff35540e44192f73c98501eacdc98";
    function getIssuer() public view returns(string) { return  "https://swarm-gateways.net/bzz:/ed8149a930eb22cdeceb4e42982ed6cd3145cebbc969b814814e34da168d2ebc/"; }
    function getArtist() public view returns(string) { return  "https://swarm-gateways.net/bzz:/9d64bafca95a826848fe9d2b3b711d99b579ff15517b414a484dfe6c6cb5d582/"; }
