...
/*
* Welcome to Proof Of Verified Contract ..
* This contract is extra verified. 
* Which is important to have, when you send ETH to a contract.
*
* Our development team has spared no efforts in making this contract verified.
* We have used the finest ASCII characters, raging from A to @.
*
* Additionally, we have performed the highest percision diff for this contract.
* In our Swiss laboratory. 
* The result were so same they have to check again, since they could not distinguish which is which.
*
* :::::::::    ::::::::   :::     :::   :::::::: 
* :+:    :+:  :+:    :+:  :+:     :+:  :+:    :+:
* +:+    +:+  +:+    +:+  +:+     +:+  +:+       
...
*
* ->Why?
* Because this is the next biggest thing.
* It is going to last forever.
* You will eventually FOMO in, you know that, right?
* 
*
* -> What?
