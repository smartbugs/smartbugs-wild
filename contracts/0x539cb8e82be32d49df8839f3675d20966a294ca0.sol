...
// File: contracts/AirisuToken.sol

/*
 * AirisuToken is a standard ERC20 token with some additional functionalities:
...
contract AirisuToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "AIRISU";
	string public constant name = "AIRISU COIN";
	uint8 public constant decimals = 18;
	uint256 public constant INITIAL_SUPPLY = 18000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 7200000000 * (10 ** uint256(decimals));
	...
	*/
	function AirisuToken(address admin) public {
	...
	* @param value Amount of airisutokens to send
	*/
