...
contract Crowdsale is Ownable {
  ...
  uint256 public constant CAP = 500; // Cap in Ether
  uint256 public constant START = now; // Sep 5, 2017 @ 08:00 GMT+1
  uint256 public constant DAYS = 7; // 7 Days

  uint256 public constant initialTokens = 1000000 * 10**18; // Initial number of tokens available
