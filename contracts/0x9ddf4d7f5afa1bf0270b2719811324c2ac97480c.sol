...
//=================_|===========================================================
    ...
    uint256 constant private rndInit_ = 20 minutes;                // round timer starts at this
    uint256 constant private rndInc_ = 8 seconds;              // every full key purchased adds this much to the timer
