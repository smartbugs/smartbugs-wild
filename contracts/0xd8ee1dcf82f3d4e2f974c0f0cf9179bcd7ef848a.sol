...
contract PresidentRamaphosaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PresidentRamaphosaCoin() {
        ...
        name = "PresidentRamaphosaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PRC";                                             // Set the symbol for display purposes (CHANGE THIS)
