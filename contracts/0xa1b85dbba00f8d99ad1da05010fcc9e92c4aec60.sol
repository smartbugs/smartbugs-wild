...
contract SWIFTSCO is StandardToken {

    string public constant name = "SWIFTS CO";
    string public constant symbol = "SWCO";
    ...
    /**
    * If the user sends 0 ether, he receives 20 tokens.
