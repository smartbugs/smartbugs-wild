...
/*
    -------------------------------------------------------------------------------------------------------
    Website: https://lootether.com/
    Exchange (We recomand to use MetaMask or TrustWallet): https://lootether.com/exchange
    Second Exchange (We recomand to use MetaMask or TrustWallet): https://lootether.com/second
    Daily Dividends 10% (We recomand to use MetaMask or TrustWallet): https://lootether.com/daily
...
contract LootEther {
    ...
    uint8 constant internal refferalFee_ = 20; // 20% from enter fee divs or 7% for each invite, great for inviting new members on LootEther
    uint8 constant internal exitFee_ = 25; // 15% for selling
