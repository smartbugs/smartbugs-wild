...
// File: contracts\zeppelin-solidity\lifecycle\TokenDestructible.sol
...
// File: contracts\zeppelin-solidity\token\ERC20\MintableToken.sol
...
// File: contracts\DemeterToken.sol

/**
 * @title Demeter Token.
 * @dev Specific Demeter token.
 */
contract DemeterToken is TokenDestructible, BurnableToken, MintableToken
{
  string public name = "Demeter.life";
  string public symbol = "DME";
  uint256 public decimals = 18;

  /**
  * @dev transfer the same amount of tokens to up to 100 specified addresses.
