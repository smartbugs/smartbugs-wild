...
contract BETHERcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    string public name= "BETHER COIN";                   // Token Name
    uint8 public decimals= 18;                // How many decimals to show. To be standard complicant keep it 18
    string public symbol= "BETHER";                 // An identifier: eg SBX, XPR etc..
