...
contract EtherPayToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EtherPayToken() {
        ...
        name = "EtherPayToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "EPT";                                             // Set the symbol for display purposes (CHANGE THIS)
