...
contract SMARTGold is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SMARTGold() {
        ...
        name = "SMART Gold";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SG";                                             // Set the symbol for display purposes (CHANGE THIS)
