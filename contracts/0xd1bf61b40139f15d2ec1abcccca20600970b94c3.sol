...
contract Skale5 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Skale5() {
        ...
        name = "Skale5";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SK5";                                             // Set the symbol for display purposes (CHANGE THIS)
