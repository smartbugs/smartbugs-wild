...
contract VEToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function VEToken() {
        ...
        name = "VEToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VET";                                             // Set the symbol for display purposes (CHANGE THIS)
