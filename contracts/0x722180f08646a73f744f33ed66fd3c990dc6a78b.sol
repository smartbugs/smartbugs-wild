...
contract SnapToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SnapToken() {
        ...
        name = "SnapToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SNPT";                                             // Set the symbol for display purposes (CHANGE THIS)
