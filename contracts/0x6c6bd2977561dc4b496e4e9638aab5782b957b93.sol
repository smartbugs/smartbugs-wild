...
contract UniBitcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function UniBitcoin() {
        ...
        name = "UniBitcoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBTC";                                             // Set the symbol for display purposes (CHANGE THIS)
