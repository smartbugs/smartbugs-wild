...
contract Spectraal is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Spectraal() {
        ...
        name = "Spectraal";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SPECT";                                             // Set the symbol for display purposes (CHANGE THIS)
