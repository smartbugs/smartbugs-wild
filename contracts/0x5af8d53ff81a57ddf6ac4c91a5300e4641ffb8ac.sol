...
contract BrinkzToken {
    ...
    function BrinkzToken() public {
        totalSupply = BrinkzSupply * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;    // Give BrinkzToken Mint the total created tokens
        creator = msg.sender;
    }
    /**
