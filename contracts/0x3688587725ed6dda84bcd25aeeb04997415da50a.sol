...
contract BFreeContract is ERC20Interface, owned{
	...
	uint256 public icoMin = 300000;					// = 300000; amount is in Tokens, 1.800.000
	uint256 public preIcoLimit = 600000;			// = 600000; amount is in tokens, 3.600.000
	...
	function BFreeContract() {
		...
		currentTokenPrice = 0.024340770791075100 * 1 ether;	// initial price of 1 Token
		preICOprice = 0.024340770791075100 * 1 ether; 			// price of 1 token in weis for the preICO time, ca.6,- Euro
		ICOprice = 0.040567951318458400 * 1 ether;				// price of 1 token in weis for the ICO time, ca.10,- Euro
		sellPrice = 0;
		updatePrices();
	}
