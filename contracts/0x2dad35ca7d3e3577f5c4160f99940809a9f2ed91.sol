...
/**
  ...
  2. Wait a little bit
  3. ...
  4. PROFIT! You have got 130%

  How is that?
  1. The first investor in the queue (you will become the
     first in some time) receives next investments until
     it become 130% of his initial investment.
  2. You will receive payments in several parts or all at once
  3. Once you receive 130% of your initial investment you are
...
/**
  ...
  2. Немного подождите
  3. ...
  4. PROFIT! Вам пришло 130% от вашего депозита.

  Как это возможно?
  1. Первый инвестор в очереди (вы станете первым очень скоро) получает выплаты от
     новых инвесторов до тех пор, пока не получит 130% от своего депозита
  2. Выплаты могут приходить несколькими частями или все сразу
  3. Как только вы получаете 130% от вашего депозита, вы удаляетесь из очереди
