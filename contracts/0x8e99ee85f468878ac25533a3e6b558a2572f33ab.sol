...
contract FRESCO is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function FRESCO() {
        ...
        name = "FRESCO";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FRES";                                             // Set the symbol for display purposes (CHANGE THIS)
