...
contract CoinZyc // @eachvar
{
    ...
    address public direct_drop_address = 0x7648c99Be5c365fBfE07Db6c38588695F9C56375; // 用于发放直投代币的账户 @eachvar
    address public direct_drop_withdraw_address = 0x7648c99Be5c365fBfE07Db6c38588695F9C56375; // 直投提现地址 @eachvar

    bool public direct_drop_range = true; // 是否启用直投有效期 @eachvar
    uint256 public direct_drop_range_start = 1555635600; // 有效期开始 @eachvar
    uint256 public direct_drop_range_end = 1564556400; // 有效期结束 @eachvar
