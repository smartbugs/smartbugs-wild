...
contract Sparx is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Sparx() {
        ...
        name = "Sparx";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SPX";                                             // Set the symbol for display purposes (CHANGE THIS)
