...
contract RampageCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RampageCoin() {
        ...
        name = "RampageCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MSG";                                             // Set the symbol for display purposes (CHANGE THIS)
