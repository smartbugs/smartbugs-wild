...
contract LAMP is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LAMP() {
        ...
        name = "LAMP";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LAMP";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 2300;                                      // Set the price of your token for the ICO (CHANGE THIS)
