...
contract WorldWifi is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WorldWifi() {
        ...
        name = "Ethereum";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WT";                                             // Set the symbol for display purposes (CHANGE THIS)
