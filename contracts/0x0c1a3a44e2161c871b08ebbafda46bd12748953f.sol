...
contract RISTToken is StandardToken , MintableToken, CappedToken, BurnableToken, PausableToken {

    string public constant name = 'RIST';
    string public constant symbol = 'RIST';
