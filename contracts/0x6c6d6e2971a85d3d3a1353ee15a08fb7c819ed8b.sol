...
THIS IS AN EXPERIMENT OF PSYCHOLOGY
...
/**
 * Definition of contract accepting EXP tokens
 * EXP Lending and other games can reuse this contract to support EXP tokens
 */
contract AcceptsExp {
...
contract Experiment {
    ...
    uint8 constant internal dividendFee_ = 4; // 4% dividend fee on each buy and sell
    uint8 constant internal fundFee_ = 1; // 1% fund tax on buys/sells/reinvest (split 80/20)
   ...
   /*================================
    ...
    // Special Experiment Platform control from scam game contracts on EXP platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept EXP tokens
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by EXP platform
    ...
    /**
     * Add or remove game contract, which can accept EXP tokens
     */
