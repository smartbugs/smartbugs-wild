...
contract OrderChain is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function OrderChain() {
        ...
        name = "OrderChain";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ORD";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 77;                                      // Set the price of your token for the ICO (CHANGE THIS)
