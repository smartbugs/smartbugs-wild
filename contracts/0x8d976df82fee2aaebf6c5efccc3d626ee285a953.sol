...
contract MOJOCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MOJOCoin() {
        ...
        name = "MOJO Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MOJO";                                             // Set the symbol for display purposes (CHANGE THIS)
