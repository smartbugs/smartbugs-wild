...
//=================_|===========================================================
    ...
    uint256 private rndExtra_ = 60;     // length of the very first ICO
    uint256 private rndGap_ = 60;         // length of ICO phase, set to 1 year for EOS.
...
//==============================================================================
    ...
    function distributeExternal(uint256 _rID, uint256 _pID, uint256 _eth, uint256 _affID, F3Ddatasets.EventReturns memory _eventData_)
        ...
        returns(F3Ddatasets.EventReturns)
    {
        // pay 20% out to community rewards
        uint256 _com = _eth / 5;
...
//====================/=========================================================
    ...
    {   
        ...
        {   round_[_rID].lastPlys[0] = _pID;
            round_[_rID].lastNum++;
            //round_[_rID].lastPlys.push(_pID);
            }else if(round_[_rID].lastNum <10)
            {
                if(round_[rID_].lastPlys[round_[_rID].lastNum-1] != _pID)
                {
                    ...
                    if(!repeat){
                        ...
                        round_[_rID].lastNum++;
                    //round_[rID_].lastPlys.push(_pID);
                    }else{
...
library F3Ddatasets {
    ...
    struct Round {
        ...
        uint256[10] lastPlys; // last player 
        uint256 lastNum;        //count lastPlys length 
    }
    struct TeamFee {
