...
contract PreSaleHelbiz is Ownable,Destructible{
    ...
    mapping (address => uint256) public tokenHoldersToClaim; //still to be claimed to someone
    mapping (address => uint256) public tokenHoldersTotal; //total token claimed to someone
    mapping (address => uint256) public tokenHoldersClaimed; //already made claimed by someone
    address[] tokenHolders; //list of tokeholders that had already claimed their token
    bool public isReady;
