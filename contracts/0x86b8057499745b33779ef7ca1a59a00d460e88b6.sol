...
contract HCOIN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HCOIN() {
        ...
        name = "HCOIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HCC";                                             // Set the symbol for display purposes (CHANGE THIS)
