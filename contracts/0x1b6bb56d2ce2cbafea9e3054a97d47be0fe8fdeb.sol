...
contract EasyTax is Ownable, StandardToken {
    ...
    string public name = "EasyTax";          // name of the token
    string public symbol = "ETX";              // ERC20 compliant 4 digit token code
    uint public decimals = 18;                  // token has 18 digit precision

    uint public totalSupply = 15000000000 ether;  // total supply of 1500000000000 Million Tokens
