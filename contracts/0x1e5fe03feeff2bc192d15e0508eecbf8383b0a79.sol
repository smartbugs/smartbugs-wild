...
contract ExChess is StandardToken {

    function ExChess() public { 
    ...
    */
    string public name = "ExChess";
    string public symbol = "ECs";
    uint public decimals = 4;
    uint public INITIAL_SUPPLY = 74000 * (10 ** decimals);
    string public Image_root = "undefined";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/d224b65465382043886ce0c4eb9076990a8a1b3458b536ff269fc738dba49dd4/";
    string public DigestCode_root = "679c9f9e92375a02b84d74bd588a8d3b89bc2a7cf754e7f464ef9b69422db669";
    function getIssuer() public view returns(string) { return  "Skyline"; }
    function getArtist() public view returns(string) { return  "Skyline"; }
