 ...
 * Name : Andromeda Chain Token (ACT)
 * Decimals : 8
...
contract AndromedaChainToken is ERC20 {
    ...
    string public constant name = "Andromeda Chain Token";
    ...
    function AndromedaChainToken () public {
        owner = msg.sender;    
