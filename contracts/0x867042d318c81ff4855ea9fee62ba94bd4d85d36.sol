...
contract GTDCStandardToken is StandardToken { 
    ...
    function GTDCStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
