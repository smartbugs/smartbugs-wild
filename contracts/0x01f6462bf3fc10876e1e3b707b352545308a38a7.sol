...
contract ONETIDC is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ONETIDC() {
        ...
        name = "ONETIDC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ONET";                                             // Set the symbol for display purposes (CHANGE THIS)
