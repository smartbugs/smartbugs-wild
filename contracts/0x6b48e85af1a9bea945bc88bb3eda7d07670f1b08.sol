...
contract GoldMintToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GoldMintToken()
    {
        ...
        name = "GoldMintToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GMT";                                             // Set the symbol for display purposes (CHANGE THIS)
