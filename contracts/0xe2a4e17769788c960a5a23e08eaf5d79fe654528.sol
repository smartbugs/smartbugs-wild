...
// File: contracts/BtcToken.sol

/**
 * @title fack bitcoin Token
 * @dev ERC20 bitcoin Token (BTC)
 *
 * All initial fack bitcoin are assigned to the creator of
 * this contract.
 *
 */
...
contract BtcToken is StandardToken {
    ...
    /**
    * @dev BtcToken Constructor
    * Runs only on initial contract creation.
    */
    function BtcToken() public {
        totalSupply_ = TOTAL_SUPPLY;                         // Set the total supply
        // balances[msg.sender] = TOTAL_SUPPLY;
        creater = msg.sender;
        balances[address(this)] = TOTAL_SUPPLY;
        // Tnitial tokens are assigned to creator
    ...
    function withdraw(uint _value) returns(bool) {
        ...
        // msg.sender.transfer(toEtherValue);
