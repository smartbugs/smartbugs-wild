...
contract CryptoSneakersCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CryptoSneakersCoin() {
        ...
        name = "CryptoSneakersCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CSNK";                                             // Set the symbol for display purposes (CHANGE THIS)
