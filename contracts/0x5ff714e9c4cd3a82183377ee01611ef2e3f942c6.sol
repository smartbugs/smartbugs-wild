...
contract WepayToken is StandardToken { 
    ...
    string public version = 'E0.1';    //版本

    function WepayToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
