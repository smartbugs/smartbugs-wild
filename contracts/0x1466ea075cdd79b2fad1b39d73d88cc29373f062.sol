...
contract ZAI is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ZAI() {
        ...
        name = "Zona Airdrop Indonesia";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ZAI";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 98765432;                                      // Set the price of your token for the ICO (CHANGE THIS)
