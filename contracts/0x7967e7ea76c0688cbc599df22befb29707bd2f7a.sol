/**
 * This smart contract code is based on BurnableCrowdsaleToken contract by TokenMarket Ltd. 
 * Modifications made by Enhanced Society include
 * - UpgradeAgent to allow from Upgrade from an older token version
 * - MintingFinished Disabled to allow issuing tokens post release
 * - Whitelist to verify sender & reciever are allowed to transfer tokens.
 */
...
contract BasicToken is ERC20Basic, Whitelist {
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    require(whitelist[msg.sender] && whitelist[_to]); //introduced for by Enhanced Society for whitelisting
...
contract CrowdsaleToken is ReleasableToken, MintableToken, UpgradeableToken {
   ...
   */
  function releaseTokenTransfer() public onlyReleaseAgent {
    // mintingFinished = true;   // Introduced by enhanced society for seurity tokens to be minted after releaseTokenTransfer
