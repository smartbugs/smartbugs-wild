...
// Smartcontract Lexon Coin
// https://github.com/ethereum/EIPs/issues/20

// Verified Status: ERC20 Verified Token
// Lexon Coin Symbol: LXX
...
/**
 * Lexon Token Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract LXXStandardToken is LexonToken, Ownable {
    
    using LXXMaths for uint256;
...
contract Lexon is LXXStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 100000000000000000 ; // 200 million tokens, 8 decimal places
    string constant public name = "Lexon Coin";
    string constant public symbol = "LXX";
