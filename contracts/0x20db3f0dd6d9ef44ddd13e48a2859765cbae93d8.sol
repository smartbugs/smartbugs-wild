...
contract FirstERC20TestToken is StandardToken {
...
//contract name above is also TutorialToken instead of FirstERC20TestToken

    function FirstERC20TestToken(
        ) {
        ...
        name = "FirstERC20TestToken";                                   // Set the name for display purposes
