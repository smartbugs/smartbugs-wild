...
contract ZivJillcoin is StandardToken {

    function ZivJillcoin() public { 
    ...
    */
    string public name = "ZivJillcoin";
    string public symbol = "ZJ";
    uint public decimals = 0;
    uint public INITIAL_SUPPLY = 520 * (10 ** decimals);
    ...
    string public DigestCode_root = "bf68e30522087834e4df15e3581ba0354ba5c8136e0a0dc0512542b7b88f4418";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/b516fb7e631390e55780c2134a2dbecc4efbbbde86ecd617143016f533716bc0/"; }
