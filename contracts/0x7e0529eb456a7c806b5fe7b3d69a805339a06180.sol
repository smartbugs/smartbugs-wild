...
/**
 * Definition of contract accepting FUNDING SECURED (FUNDS) tokens
 * Games or any other innovative platforms can reuse this contract to support FUNDING SECURED (FUNDS) tokens
 */
...
contract FUNDS {
   ...
   /*================================
    ...
    // Special Funding Secured Platform control from scam game contracts on Funding Secured platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept Funding Secured tokens
    ...
    */
     ...
     * The address is here https://etherscan.io/address/0x6BeF5C40723BaB057a5972f843454232EEE1Db50
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by Funding Secured platform
    ...
    /**
     * Add or remove game contract, which can accept Funding Secured (FUNDS) tokens
     */
