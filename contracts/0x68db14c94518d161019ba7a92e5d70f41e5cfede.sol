...
contract SogetiCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SogetiCoin() {
        ...
        name = "SogetiCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SOGETI";                                             // Set the symbol for display purposes (CHANGE THIS)
