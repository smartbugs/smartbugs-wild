...
contract IraDavies is StandardToken {

    function IraDavies() public { 
    ...
    */
    string public name = "IraDavies";
    string public symbol = "IDaiessd";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 978180 * (10 ** decimals);
    ...
    string public DigestCode_root = "9869c8d924f9ab1e4215e6af08691e87a0e333d478bdce10aa161bbacc2ad341";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/6bd50d1750813a094d82a190f4a4def46f086caf042c3b973bfcb7d3654420fa/"; }
