...
// ERC20 Smartcontract for GanaEightCoin, for more information visit http://ganapati.io
// Symbol: G8C
// Status: ERC20 Verified

contract GANAPATIToken { 
...
/**
 * GANAPATIToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract G8CStandardToken is GANAPATIToken, Ownable {
...
contract G8C is G8CStandardToken {
    ...
    */
    ...
    string constant public name = "G8C"; 
    string constant public symbol = "G8C"; 
