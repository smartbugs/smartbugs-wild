...
contract ExUrus is StandardToken {
    ...
    */
    string public name = "ExUrus";
    string public symbol = "EUr";
    uint public decimals = 4;
    uint public INITIAL_SUPPLY = 1000 * (10 ** decimals);
    string public Image_root = "undefined";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/47061fe540268d42679474221278b68ca63527857de49aceb5f74a228cb0ffb5/";
    string public DigestCode_root = "60ef9bd5d7940a819e15fc718abf5124dafda39e04bd3f307f0028d5f0f5934b";
    function getIssuer() public view returns(string) { return  "LAMBORGHINI"; }
    function getArtist() public view returns(string) { return  "Someone"; }
