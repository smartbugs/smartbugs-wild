...
contract GemstoneToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GemstoneToken() {
        ...
        totalSupply = 200000000;                        // Update total supply (1000 for example) (CHANGE THIS)
        name = "GemstoneToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GST";                                             // Set the symbol for display purposes (CHANGE THIS)
