 ...
 * CLPT smart contract.
 */
contract CLPT is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 500000000000 * (10**8);
  ...
  string constant public name = "PesosTether";
  string constant public symbol = "CLPT";
