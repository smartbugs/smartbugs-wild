...
contract watch is StandardToken {
    ...
    */
    string public name = "watch";
    string public symbol = "watch";
    uint public decimals = 0;
    uint public INITIAL_SUPPLY = 10000 * (10 ** decimals);
    string public Image_root = "";
    string public Note_root = "";
    string public DigestCode_root = "c0323552d2f161b30758f9044ebc52bcae7c884f2db27870f80dbeacb2d6fc21";
    function getIssuer() public view returns(string) { return  "https://swarm-gateways.net/bzz:/6a8a660f67e94ec8594859589ecbc53bdc03a6cd343df006202051cf4e777887/"; }
    function getArtist() public view returns(string) { return  "https://swarm-gateways.net/bzz:/f6446e7c1cd949e7dc6a61cf1ccc6fa11959f3f3f27ddce6dddc5ab25db71d37/"; }
