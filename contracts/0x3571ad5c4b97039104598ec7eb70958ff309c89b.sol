...
contract SpheroidUniverseToken is MintableToken {
  string public constant name = "Spheroid Universe Token";
  string public constant symbol = "SPDU";
  uint32 public constant decimals = 18;
 
  mapping (address => bool) private saleAgents; 
  uint256 public cap;

  function SpheroidUniverseToken(uint256 _cap) public {
    require(_cap > 0);
    cap = _cap;
  }
