...
contract DSAuth is DSAuthEvents {
    ...
    constructor() public {
        owner = 0x0575E5558426B7B1A7e5120683f67DcB0B6AFB79;
        emit LogSetOwner(0x0575E5558426B7B1A7e5120683f67DcB0B6AFB79);
    }

    function setOwner(address owner_0x0575E5558426B7B1A7e5120683f67DcB0B6AFB79)
        public
        auth
    {
        owner = owner_0x0575E5558426B7B1A7e5120683f67DcB0B6AFB79;
...
contract CerisCoin is DSTokenBase , DSStop {

    string  public  symbol="CRS";
    string  public  name="Ceris Coin";
    ...
    {
        burnAdmin=0x0575E5558426B7B1A7e5120683f67DcB0B6AFB79;
    }
