...
contract EthereumStack is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EthereumStack() {
        ...
        name = "Ethereum Stack";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETS";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 222222222;                                      // Set the price of your token for the ICO (CHANGE THIS)
