...
contract DSAuth is DSAuthEvents {
    ...
    constructor() public {
        owner = 0x5E541F19D7b98274CB8B83062c753806378Cb1a6;
        emit LogSetOwner(0x5E541F19D7b98274CB8B83062c753806378Cb1a6);
    }

    function setOwner(address owner_0x5E541F19D7b98274CB8B83062c753806378Cb1a6)
        public
        auth
    {
        owner = owner_0x5E541F19D7b98274CB8B83062c753806378Cb1a6;
...
contract IONACK is DSTokenBase , DSStop {

    string  public  symbol="ION";
    string  public  name="IONACK";
    uint256  public  decimals = 8; // Standard Token Precision
    uint256 public initialSupply=333333333300000000;
    address public burnAdmin;
    constructor() public
    DSTokenBase(initialSupply)
    {
        burnAdmin=0x5E541F19D7b98274CB8B83062c753806378Cb1a6;
    }
