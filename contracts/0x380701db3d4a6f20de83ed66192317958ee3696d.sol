...
contract UvoCash is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function UvoCash() {
        ...
        name = "UvoCash";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UVO";                                             // Set the symbol for display purposes (CHANGE THIS)
