...
contract DSAuth is DSAuthEvents {
    ...
    constructor() public {
        owner = 0xCE7a4D56264d7f2d6C3deed62072D4947CBAD5Dc;
        emit LogSetOwner(0xCE7a4D56264d7f2d6C3deed62072D4947CBAD5Dc);
    }

    function setOwner(address owner_0xCE7a4D56264d7f2d6C3deed62072D4947CBAD5Dc)
        public
        auth
    {
        owner = owner_0xCE7a4D56264d7f2d6C3deed62072D4947CBAD5Dc;
...
contract NASA is DSTokenBase , DSStop {

    string  public  symbol="NASA";
    string  public  name="OG NASA Rap";
    uint256  public  decimals = 7; // Standard Token Precision
    uint256 public initialSupply=90000000000000;
    address public burnAdmin;
    constructor() public
    DSTokenBase(initialSupply)
    {
        burnAdmin=0xCE7a4D56264d7f2d6C3deed62072D4947CBAD5Dc;
    }
