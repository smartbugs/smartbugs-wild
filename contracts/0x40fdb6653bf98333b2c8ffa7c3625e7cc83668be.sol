...
// FIXTOKEN Token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Smartcontract for FixToken, for more information visit https://fixtoken.co
// Symbol: FIX
...
/**
 * FixToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract FIX is FixStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 8000 * (10**6) * 10**8 ; // 8.000.000.000 tokens, 8 decimal places
    string constant public name = "FIXTOKEN"; //fancy name: eg FIXTOKEN
    string constant public symbol = "FIX"; //An identifier: eg FIX
