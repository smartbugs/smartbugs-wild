...
contract ExFamicom is StandardToken {

    function ExFamicom() public { 
    ...
    */
    string public name = "ExFamicom";
    string public symbol = "EFC";
    uint public decimals = 3;
    uint public INITIAL_SUPPLY = 1983 * (10 ** decimals);
    string public Image_root = "undefined";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/959ce27b749be6f62b25785888afcf8cb377693705ab8a55e63a86aac8cfb95c/";
    string public DigestCode_root = "a34db5068b2eb17e8dcfa1a4a0eb0d5ee20f58c666a2762aec2c162e705728b4";
    function getIssuer() public view returns(string) { return  "Nintendo"; }
    function getArtist() public view returns(string) { return  "Nintnedo"; }
