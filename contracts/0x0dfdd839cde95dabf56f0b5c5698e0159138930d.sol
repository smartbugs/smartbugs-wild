...
contract MyFiChain is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MyFiChain() {
        ...
        name = "MyFiChain";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "myfi";                                             // Set the symbol for display purposes (CHANGE THIS)
