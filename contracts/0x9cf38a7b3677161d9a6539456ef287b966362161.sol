...
contract BMCTToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BMCTToken() {
        ...
        name = "BMCTToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BMCT";                                             // Set the symbol for display purposes (CHANGE THIS)
