...
contract QOOK is StandardToken {

    function QOOK() public { 
    ...
    */
    string public name = "QOOK";
    string public symbol = "QK";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 4500 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/952dfa2bfb9294c3bca9f844bfb8089a28a8f4bc913f9881fe529ffbe17fc497/";
    string public Note_root = "https://swarm-gateways.net/bzz:/835ab8e3f3500f7c0d21bfc8aa27feaf75ae599208fcb08295353a6c9f87e6eb/";
    string public DigestCode_root = "3b670972c7d3efab8f577bace98611220a834e3948b4363c7db322b47830da6c";
    function getIssuer() public view returns(string) { return  "MuseOKuvre"; }
    function getArtist() public view returns(string) { return  "LeonaVinci"; }
