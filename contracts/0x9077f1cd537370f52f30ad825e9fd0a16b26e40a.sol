...
contract CenturyXToken is MintableToken, BurnableToken, PausableToken {
...
contract CenturyXTokenSafe is TokenSafe {
    ...
    public
  {
    ...
    init(
      1, // Group Id
      1544724000 // Release date = 2018-12-13 18:00 UTC
    );
    add(
      1, // Group Id
      0x1ffdaB90db08d0e8315e047A89A196ae657ed280,  // Token Safe Entry Address
      4800000000000000000000000  // Allocated tokens
    );
    add(
      1, // Group Id
      0x1ffdaB90db08d0e8315e047A89A196ae657ed280,  // Token Safe Entry Address
      210000000000000000000000  // Allocated tokens
    );
    
    // Group "Reserved"
    init(
      2, // Group Id
      1551434400 // Release date = 2019-03-01 10:00 UTC
    );
    add(
      2, // Group Id
      0x1ffdaB90db08d0e8315e047A89A196ae657ed280,  // Token Safe Entry Address
      3570000000000000000000000  // Allocated tokens
    );
    
    // Group "Core Team/ Advisors"
    init(
      3, // Group Id
      1591005600 // Release date = 2020-06-01 10:00 UTC
    );
    add(
      3, // Group Id
      0x1ffdaB90db08d0e8315e047A89A196ae657ed280,  // Token Safe Entry Address
      6300000000000000000000000  // Allocated tokens
    );
  }
}
...
/**
 * @title CenturyXTokenFundraiser
 */

contract CenturyXTokenFundraiser is MintableTokenFundraiser, IndividualCapsFundraiser, CappedFundraiser, ForwardFundsFundraiser, TieredFundraiser, GasPriceLimitFundraiser {
    CenturyXTokenSafe public tokenSafe;
        ...
        public
    {
        ...
        initializeBasicFundraiser(
            1550484000, // Start date = 2019-02-18 10:00 UTC
            1566122400,  // End date = 2019-08-18 10:00 UTC
            1000, // Conversion rate = 1000 XXI per 1 ether
            0x1ffdaB90db08d0e8315e047A89A196ae657ed280     // Beneficiary
        );
        ...
        initializeGasPriceLimitFundraiser(
            60000000000 // Gas price limit in wei
        );
    ...
    function getConversionRate() public view returns (uint256) {
        ...
        if (now >= 1550484000 && now < 1564653600)
