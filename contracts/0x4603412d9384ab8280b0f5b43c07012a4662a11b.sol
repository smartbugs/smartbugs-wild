...
contract DINAR is StandardToken {    // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DINAR() {
        ...
        totalSupply = 3500000000*1000000000000000000;                        // Update total supply (CHANGE THIS)
        name = "DINAR";                                          // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DINAR";                                             // Set the symbol for display purposes (CHANGE THIS)
