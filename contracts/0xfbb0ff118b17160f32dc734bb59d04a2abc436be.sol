/*! ppmt.sol | (c) 2018 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | License: MIT */
...
/*
    ICO Gap
    - Crowdsale идет в 4 шага:
    - 1-ый шаг PreSale 0: администратор может выдавать токены; покупка и продажа закрыты; макс. токенов 5 000 000
    - 2-ый шаг PreSale 1: администратор НЕ может выдавать токены; продажа открыта; покупка закрыта; макс. токенов 5 000 000 + 10 000 000
    - 3-ый шаг PreSale 2: администратор НЕ может выдавать токены; продажа открыта; покупка закрыта; макс. токенов 5 000 000 + 10 000 000 + 15 000 000
    - 4-ый шаг ICO: администратор НЕ может выдавать токены; продажа открыта; покупка открыта; макс. токенов 5 000 000 + 10 000 000 + 15 000 000 + 30 000 000
    - Дополнение:
    - общая эмиссия ограничена: 100 000 000 токенов
    - на каждом шаге возможно изменить цену токена
    - шаги не ограничены по времени и переключение шага происходит администратором `nextStep`
