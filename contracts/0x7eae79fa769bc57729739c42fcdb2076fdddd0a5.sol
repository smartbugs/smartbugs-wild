...
contract Bitescia is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Bitescia() {
        ...
        name = "Bitescia";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ITS";                                             // Set the symbol for display purposes (CHANGE THIS)
