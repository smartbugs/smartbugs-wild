...
contract IndonesiaRupiah is StandardIDR { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function IndonesiaRupiah() {
        ...
        name = "Indonesia Rupiah";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "IDR";                                             // Set the symbol for display purposes (CHANGE THIS)
