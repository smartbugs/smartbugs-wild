...
/**
* Get % profit every month with a Fortune 111 contract!
* GitHub https://github.com/fortune333/fortune111
* Site https://fortune333.online/
*
* - OBTAINING 33.3% PER 1 MONTH. (percentages are charged in equal parts every 1 sec)
* 1.11%        per 1 day
* 0.0185%      per 1 hour
* 0.0033083%   per 1 minute
* 0.000005515% per 1 sec
* - lifetime payments
...
* 1.11% is paid to the referral (inviting) wallet - right there! Instantly!
* 1.11% is added to the first contribution of the referral (new investor).
* For example: Your first contribution is 1 Ether.
* The one who invited you gets 0.011 Ethers on his wallet, that is, a wallet that the investor will indicate when they first invest in a smart contract in the DATE field
* The invited (new investor) will receive an additional 1.11% referral bonus to their contribution, that is, the contribution of the new investor will be 1,011 Ethers!
* 
*
