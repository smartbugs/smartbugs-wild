...
contract LuuiToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LuuiToken() {
        ...
        name = "LuuiHub";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LHB";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 285;                                      // Set the price of your token for the ICO (CHANGE THIS)
