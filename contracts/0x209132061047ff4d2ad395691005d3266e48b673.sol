...
contract IdGameCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function IdGameCoin() public {
        balances[msg.sender] = 30000000000000000000000000;               // Give the creator all initial tokens. 
        totalSupply = 30000000000000000000000000;                        // Update total supply
        name = "IdGameCoin";                                   // Set the name for display purposes
        decimals = 18;                                               // Amount of decimals for display purposes 
        symbol = "IDGO";                                             // Set the symbol for display purposes 
        unitsOneEthCanBuy = 1000;                                      // Set the price of your token for the ICO 
        owner = msg.sender;                                     // The owner of the contract gets ETH
        startPreIco  = now;
        startIco = 1556748000;                          // 02/05/2019
        bonusEnds = 1546293600;                            // The end of the bonus 31/12/2018
        endIco = 1568062800;                                // 09/09/2019
    }
