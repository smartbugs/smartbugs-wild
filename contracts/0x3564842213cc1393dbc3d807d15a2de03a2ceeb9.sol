...
// File: contracts/TokenFallback.sol

/**
 * @title TokenFallback ERC 677
 */
...
// File: contracts/CoinsdomCoin.sol

/**
 * @title CoinsdomCoin Contract
 */
...
contract CoinsdomCoin is MintableToken, Pausable {
    ...
    /**
     * @dev transfer function, revert if the contract is paused.
     **/
    function transfer(
        address _to,
        uint256 _value
    ...
    /**
     * @dev transferFrom function, revert if the contract is paused.
     **/
    ...
    /**
     * @dev approve function, revert if the contract is paused.
     **/
    function approve(
        address _spender,
        uint256 _value
    ...
    /**
     * @dev increaseApproval function, revert if the contract is paused.
     **/
    ...
    /**
     * @dev decreaseApproval function, revert if the contract is paused.
     **/
    ...
    /**
     * @dev Check if the given address is a contract address
    ...
    /**
     * @dev Add contract address to tokenFallbackWhiteList
     * @param _address Contract Address
     */
    ...
    /**
     * @dev Remove contract address from tokenFallbackWhiteList
     * @param _address Contract Address
     */
