...
contract F3Devents {
    ...
    // (OK3D short only) fired whenever a player tries a buy after round timer
    ...
    // (OK3D short only) fired whenever a player tries a reload after round timer
    // hit zero, and causes end round to be ran.
...
//==============================================================================
        ...
        public
    {
        ...
        fees_[0] = F3Ddatasets.TeamFee(28,10);   //50% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[1] = F3Ddatasets.TeamFee(36,10);   //43% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[2] = F3Ddatasets.TeamFee(51,10);  //20% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[3] = F3Ddatasets.TeamFee(40,10);   //35% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot

        // how to split up the final pot based on which team was picked
        // (F3D, P3D)
        potSplit_[0] = F3Ddatasets.PotSplit(25,10);  //48% to winner, 25% to next round, 2% to com
        ...
        potSplit_[3] = F3Ddatasets.PotSplit(20,20);  //48% to winner, 10% to next round, 2% to com
