...
contract CTOcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CTOcoin() {
        ...
        name = "CTOcoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CTO";                                             // Set the symbol for display purposes (CHANGE THIS)
