...
// File: contracts/NEURONE.sol

/**
 * Holders of NEURONE can claim ERC20 as it is mined using the claimTokens()
 * function. This contract will be fed ERC20 automatically by the ERC20 ERC20
 * contract.
 */
contract NEURONE is MintableToken {
   ...
   * @param _payee The address of the payee (NEURONE holder)
   */
   ...
   * reaches the point that would make the gas cost of transferring NEURONE
