...
contract NiggerCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NiggerCoin() {
        ...
        name = "NiggerCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NIGR";                                             // Set the symbol for display purposes (CHANGE THIS)
