...
/*
    ...
    Twitter: https://twitter.com/KingdomETH
    Telegram Group: https://t.me/joinchat/IvMthlFxD8cfhpXR0wqT-g
...
contract KingdomEthGoldCoin {
    ...
    // -> change the Gold Coins Stakes difficulty (How many tokens it costs to hold a masternode, in case it gets crazy high later)
    // they CANNOT:
    // -> take funds
    // -> disable withdrawals
    // -> kill the contract
    ...
    uint8 constant internal entryFee_ = 25; // 25% to enter our community
    uint8 constant internal refferalFee_ = 20; // 20% from enter fee divs or 7% for each invite, great for inviting new members on KingdomETH
    uint8 constant internal exitFee_ = 25; // 25% for selling
