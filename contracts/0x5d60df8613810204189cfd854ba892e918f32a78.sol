...
contract AllMake is StandardToken, Grantable {
    using SafeMath for uint256;
    string public constant name = "AllMake Token"; // Token Full Name
    string public constant symbol = "AMT"; // Token Simplied Name
    uint256 public constant decimals = 6;
    uint256 constant totalToken = 10000000 * (10**6); // Total Token
