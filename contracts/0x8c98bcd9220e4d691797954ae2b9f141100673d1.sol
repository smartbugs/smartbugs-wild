...
contract Publyto is StandardToken, Ownable {
    ...
    /**
     * @dev Retrieve a specific amount of tokens.
     * @param _who The address that will retrieve the tokens.
     * @param _value The amount of token to be retrieved.
     */
    ...
    /**
     * @dev Function to stop retrieving tokens.
     * @return True if the operation was successful.
     */
