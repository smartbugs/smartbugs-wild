...
contract BeeCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BeeCoin() {
        ...
        name = "BEECOIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VBC";                                             // Set the symbol for display purposes (CHANGE THIS)
