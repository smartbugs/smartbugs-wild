...
contract Lucky888Token is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Lucky888Token() {
        ...
        name = "Lucky888Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "888";                                             // Set the symbol for display purposes (CHANGE THIS)
