...
contract CXCoin is Pausable, DetailedERC20 {
  ...
  function CXCoin() DetailedERC20("COINGENX", "CX", 18) public {
    unlocktime = 1564070400;                              // 2019/7/26 00:00:00
    totalSupply = 2 * (10**9) * 10**uint256(decimals);  // 2 billion
    uint256 ownerLock = totalSupply -  1 * (10**9) * 10**uint256(decimals); // 1 billion
