...
/**
 * @title ArenaCoin token
 **/
 contract ArenaCoin is StandardBurnableToken, PausableToken {
    using SafeMath for uint256;
    string public constant name = "ArenaCoin";
    string public constant symbol = "ANC";
    uint8 public constant decimals = 8;
    uint256 public constant INITIAL_SUPPLY = 1e10 * (9 ** uint256(decimals));
