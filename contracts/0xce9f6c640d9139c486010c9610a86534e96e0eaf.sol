...
contract VPN is PausableToken {

    string public constant name = "VPN";
    string public constant symbol = "VPN";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_INITIAL = 1000000000000000000 * (10 ** uint256(decimals));
