...
contract TheDXNetwork is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TheDXNetwork() {
        ...
        name = "TheDXNetwork";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DXN";                                             // Set the symbol for display purposes (CHANGE THIS)
