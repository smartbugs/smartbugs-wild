...
contract NapoleonPicture is StandardToken {

    function NapoleonPicture() public { 
    ...
    */
    string public name = "NapoleonPicture";
    string public symbol = "NAPP1001";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 7705555 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/b5f84bbc2f7fedb400137cec57ef119aa3689be359f5092afc92db7695abd824/";
    string public Note_root = "https://swarm-gateways.net/bzz:/6a011d537c1e88b1373aae7df78f75751449943ff2e15090a9c8faaf1865b848/";
    string public DigestCode_root = "381264c5e8a68f41b715cdb5570c1253da38dae1b5595d4205a4c14dd017f4ed";
    function getIssuer() public view returns(string) { return  "issuerName"; }
    function getArtist() public view returns(string) { return  "artistName"; }
