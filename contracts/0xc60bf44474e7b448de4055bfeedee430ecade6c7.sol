...
contract MuskmelonHJ is StandardToken {

    function MuskmelonHJ() public { 
    ...
    */
    string public name = "MuskmelonHJ";
    string public symbol = "MHJ";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 620150 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/a5d3eac5901ab3fe5a23af98d841f5e44e0f36eda3e86b95a0fa9fcea8ddcab6/";
    string public Note_root = "https://swarm-gateways.net/bzz:/ed57ac3d17a15eff2b602bb959448081153e679c13d94e9c884bd92561403519/";
    string public DigestCode_root = "5a6fc16eb09537309775b8baadff4d433b3f95ed3e33d3ba8777536e2534ab0b";
    function getIssuer() public view returns(string) { return  "Musk"; }
    function getArtist() public view returns(string) { return  "Mulon"; }
