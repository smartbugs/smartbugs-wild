...
contract ONEWEI is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    string public name= "ONEWEI";                   // Token Name
    uint8 public decimals= 18;                // How many decimals to show. To be standard complicant keep it 18
    string public symbol= "ONW";                 // An identifier: eg SBX, XPR etc..
    string public version = 'H1.0'; 
    uint256 public unitsOneEthCanBuy= 1000000;     // How many units of your coin can be bought by 1 ETH?
    ...
    function ONEWEI() {
        ...
        name = "ONEWEI";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ONW";                                             // Set the symbol for display purposes (CHANGE THIS)
