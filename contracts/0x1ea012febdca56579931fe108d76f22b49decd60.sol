...
contract TokensOfGratitude is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TokensOfGratitude() {
        ...
        name = "TokensOfGratitude";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TOGA";                                             // Set the symbol for display purposes (CHANGE THIS)
