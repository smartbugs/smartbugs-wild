...
contract CNTP is Owned, ERC20Token {
    using SafeMath for uint256;

    string private constant standard = "20181188ebc4";
    string private constant version = "5.00acb65";
    string private name_ = "CNTP";
    string private symbol_ = "CNTP";
