...
contract Trade is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Trade() {
        ...
        name = "Tradecoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "Trade";                                             // Set the symbol for display purposes (CHANGE THIS)
