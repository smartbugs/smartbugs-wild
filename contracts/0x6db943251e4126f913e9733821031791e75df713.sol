...
//==============================================================================
        ...
        public
    {
        ...
        // (分红, 推广经费)
        potSplit_[0] = RP1datasets.PotSplit(18,4);  //58% to winner, 18% to next round, 2% to com
        potSplit_[1] = RP1datasets.PotSplit(25,0);  //58% to winner, 15% to next round, 2% to com
        potSplit_[2] = RP1datasets.PotSplit(22,8);  //58% to winner, 10% to next round, 2% to com
        potSplit_[3] = RP1datasets.PotSplit(32,2);  //58% to winner,  6% to next round, 2% to com
	}
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
