...
contract Nothing is StandardToken {
    ...
    function Nothing() {
        balances[msg.sender] = 100000000000000000000000000000000;               // Starting supply
        totalSupply = 100000000000000000000000000000000;                        // Total supply
        name = "Nothing";                                   // Token Display Name
        decimals = 18;                                               // Decimals
        symbol = "NOT";                                             // Token Symbol
        unitsOneEthCanBuy = 7500000;                                      // ICO Price
