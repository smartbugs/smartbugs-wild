...
contract STERNIUMHUGEELLIGENCECOIN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function STERNIUMHUGEELLIGENCECOIN() {
        ...
        name = "STERNIUM HUGE ELLIGENCE COIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SHE";                                             // Set the symbol for display purposes (CHANGE THIS)
