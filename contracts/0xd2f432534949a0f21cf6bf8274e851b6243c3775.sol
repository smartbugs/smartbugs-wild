...
contract Annie is StandardToken {

    function Annie() public { 
    ...
    */
    string public name = "Annie";
    string public symbol = "An";
    uint public decimals = 6;
    uint public INITIAL_SUPPLY = 88888 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/768c43245e018ab5c3a1de93e905050c574521a752a873e100397377ae075797/";
    string public Note_root = "";
    string public DigestCode_root = "46ddef520f3bdb3130cd36c4694952a59f0e5e1fa3e48d52d5bec73b85e117ed";
    function getIssuer() public view returns(string) { return  "Annie"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/c8ec9c8fa30c9e12f652b47f142b0feb707f02a8fdeb89b96ed4c976a21488f0/"; }
