...
contract CentHungary is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CentHungary() {
        ...
        name = "CentHungary";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CHU";                                             // Set the symbol for display purposes (CHANGE THIS)
