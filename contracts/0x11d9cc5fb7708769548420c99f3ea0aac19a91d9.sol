...
contract VenuxCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function VenuxCoin() {
        ...
        name = "VenuxCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VXC";                                             // Set the symbol for display purposes (CHANGE THIS)
