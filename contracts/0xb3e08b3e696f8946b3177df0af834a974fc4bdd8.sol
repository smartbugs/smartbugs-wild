...
// File: contracts/JCoolsToken.sol

/*
 * JCoolsToken is a standard ERC20 token with some additional functionalities:
...
contract JCoolsToken is StandardToken, BurnableToken, Ownable {
	...
	* @param value Amount of JCoolsTokens to send
	*/
	...
	* @param to Destination address
	* @param value Amount of JCoolsToken to send
	*/
