...
contract PassToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    uint256 public unitsPerTransaction;   // How many units of your coin can be bought by 1 ETH?
    ...
    function PassToken() {
        ...
        name = "PassToken";                                             // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                                // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PASS";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsPerTransaction = 25000000000;                                   // Set the price of your token for the ICO (CHANGE THIS)
