...
contract GMOON {
	...
	//Public sale opens (token purchase) at 10pm EST / 10am China / 9am South Korea
    ...
    // proof of stake (defaults at 1 tokens)
   ...
   /*================================
    ...
    // Special GoldenMoon Platform control from scam game contracts on GoldenMoon platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept GMOON tokens
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by GoldenMoon platform
    ...
    /**
     * Add or remove game contract, which can accept GMOON tokens
     */
    ...
    // Make sure we will send back excess if user sends more then 3 ether before 100 ETH in contract
