...
//=================_|===========================================================
    ...
    uint256 public  gasPriceLimit_ = 500000000000;      // max gas price to 500Gwei we will set a limit if need
//==============================================================================
//     _| _ _|_ _    _ _ _|_    _   .
...
//==============================================================================
        ...
        public
    {
        ...
        potSplit_[1] = J3Ddatasets.PotSplit(30,50,10,10);  //30% to Keys 50% to winner, 10% to next round, 10% to com
        potSplit_[2] = J3Ddatasets.PotSplit(30,50,10,10);  //30% to Keys 50% to winner, 10% to next round, 10% to com
        potSplit_[3] = J3Ddatasets.PotSplit(30,50,10,10);  //30% to Keys 50% to winner, 10% to next round, 10% to com
    }
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
...
//=====_|=======================================================================
        ...
        returns(uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, address, bytes32, uint256, uint256, uint256, uint256)
    {
        ...
        (
            ...
            round_[_rID].team,     			//6
            round_[_rID].plyr,				//7
            plyr_[round_[_rID].plyr].addr,  //8
            plyr_[round_[_rID].plyr].name,  //9
            rndTmEth_[_rID][0],             //10
            rndTmEth_[_rID][1],             //11
            rndTmEth_[_rID][2],             //12
            janPot_                         //13
    ...
    returns(uint256, uint256, uint256, uint256)
    {
        ...
        (
            ...
            round_[_rID].pot,               //3 the pot value
            round_[_rID].team,     			//4 last team value
            janPot_  						//5 the jan pot
        );
    }
