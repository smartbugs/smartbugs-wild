...
contract BitcoinpalletToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BitcoinpalletToken() {
        ...
        name = "BitcoinpalletToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BCP";                                             // Set the symbol for display purposes (CHANGE THIS)
