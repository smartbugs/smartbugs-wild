...
contract oxleytoken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function oxleytoken() {
        ...
        name = "oxleytoken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "OXLEY";                                             // Set the symbol for display purposes (CHANGE THIS)
