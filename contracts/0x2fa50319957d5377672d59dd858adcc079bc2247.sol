...
contract IOweYou is StandardToken {
    ...
    */
    string public name = "I Owe You";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "IOU";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function IOweYou(
        ...
        name = "I Owe You";                                   // Set the name for display purposes
        decimals = 0;                            // Amount of decimals for display purposes
        symbol = "IOU";                               // Set the symbol for display purposes
    }
