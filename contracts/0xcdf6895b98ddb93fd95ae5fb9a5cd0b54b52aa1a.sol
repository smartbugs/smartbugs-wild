...
contract SaxoToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SaxoToken() {
        ...
        name = "SaxoToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SXT";                                             // Set the symbol for display purposes (CHANGE THIS)
