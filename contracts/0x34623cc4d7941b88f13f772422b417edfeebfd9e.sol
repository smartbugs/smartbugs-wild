...
contract WOLFEXDistribution is Claimable, NoOwner, Destructible {
    ...
    /**
    * @notice Bulk mint tokens (same amount)
    ...
    */
    ...
    /**
     * @notice Finish token minting. NO NEW TOKENS can be created after calling this
     */
    ...
    /**
     * @notice Allows transfer token ownership back to distribution contract
     */
