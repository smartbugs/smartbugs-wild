...
contract TESTAGAIN is StandardToken {

    function TESTAGAIN() public { 
    ...
    */
    string public name = "TESTAGAIN";
    string public symbol = "SSSS";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 9999999999 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/04e94afd7a59e2659357f020312d02871a5eca538e8d6ac482f075b7932a2ef9/";
    string public Note_root = "";
    string public DigestCode_root = "e55026a5bad414f4e8ecfc3f02a9c91c1c5d4a42e1b8547cf2ad73eb0dcaaf0c";
    function getIssuer() public view returns(string) { return  "SSSSSS"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/50eed63ef94afbb112a9a9b0b18dbcb3da64e9bf3e698ab5c0a7bcdb1f958e1c/"; }
