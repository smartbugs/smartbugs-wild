 ...
 * Welcome to AKI Coin
 *
 * A world of luxury and comfort awaits the daring investor.
 *
 * Visit https://www.akicoin.io for more information
 */
...
contract AkiCoin is ERC223Interface, ERC20CompatibleToken {
    ...
    /**
     * @dev Transfer the specified amount of tokens to the specified address.
     *      This function works the Akie with the previous one
