...
contract Appppple is StandardToken {

    function Appppple() public { 
    ...
    */
    string public name = "Appppple";
    string public symbol = "ape";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 247560 * (10 ** decimals);
    ...
    string public DigestCode_root = "92904bff36b05a4f6c67a58f172bf987898086571648947c8c1844685cad8740";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/97dea1717dc58861f544b7fae88d33464ca5e0806fed26f8ce96628aeac3d1dc/"; }
