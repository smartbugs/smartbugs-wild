...
contract BabyDragon is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BabyDragon() {
        ...
        name = "BabyDragon";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BDN";                                             // Set the symbol for display purposes (CHANGE THIS)
