...
contract Worldtvcoin is StandardToken { // CHANGE THIS. Update the contract name.

    /* Public variables of the token */

    /*
    NOTE:*************************W O R L D T V C O I N*****************************
    ********W O R L D T V C O I N**************W O R L D T V C O I N*****
********W O R L D T V C O I N**************W O R L D T V C O I N*************W O R L D T V C O I N**************W O R L D T V C O I N*****
    ********W O R L D T V C O I N**************W O R L D T V C O I N*************W O R L D T V C O I N**************W O R L D T V C O I N*****
   */
    ...
    function Worldtvcoin() {
        ...
        totalSupply = 210000000;                        // Update total supply (1000 for example) (CHANGE THIS)
        name = "Worldtvcoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WTV";                                             // Set the symbol for display purposes (CHANGE THIS)
