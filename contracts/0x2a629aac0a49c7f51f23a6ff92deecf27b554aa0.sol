...
contract ERC20Token is CrowdsaleCompatible, EditableToken, ThirdPartyTransferableToken {
    ...
    constructor() public
    {
        balanceOf[0xb02ea41cf7e8c47d5958defda88e46b9786e12ae] = uint256(1000000000) * 10**18;
        emit Transfer(address(0x0), 0xb02ea41cf7e8c47d5958defda88e46b9786e12ae, balanceOf[0xb02ea41cf7e8c47d5958defda88e46b9786e12ae]);

        transferOwnership(0xb02ea41cf7e8c47d5958defda88e46b9786e12ae);

        totalSupply = 1000000000 * 10**18;                  // Update total supply
        name = 'GoldyCash';                                   // Set the name for display purposes
        symbol = 'GCX';                               // Set the symbol for display purposes
