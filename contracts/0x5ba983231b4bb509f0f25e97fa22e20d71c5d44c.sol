...
contract MyAdvancedToken is owned, TokenERC20 {
    ...
    function MyAdvancedToken() TokenERC20(0, "FOF Token", "FOF") public {
        sellPrice = (uint256(10) ** decimals) / 110000000;/*that is 100000*100000*100000, and then 100000000 tokens for 1 ether*/
        buyPrice  = (uint256(10) ** decimals) / 110000;/*that is 100000*100000*100000, and then 1 ether for 100000 tokens*/
    }
