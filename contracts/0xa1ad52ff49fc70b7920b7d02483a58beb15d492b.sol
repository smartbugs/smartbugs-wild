...
//==============================================================================
        ...
        public
    {
        ...
        fees_[2] = F3Ddatasets.TeamFee(18,0);//(56,10);  //20% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
       // fees_[3] = F3Ddatasets.TeamFee(51,0);//(43,8);   //35% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        
        // how to split up the final pot based on which team was picked
        // (F3D, P3D)
        potSplit_[0] = F3Ddatasets.PotSplit(10,20);//(15,10);  //48% to winner, 25% to next round, 2% to com
        potSplit_[1] = F3Ddatasets.PotSplit(5,20);   //48% to winner, 25% to next round, 2% to com
        potSplit_[2] = F3Ddatasets.PotSplit(20,20);//(20,20);  //48% to winner, 10% to next round, 2% to com
       // potSplit_[3] = F3Ddatasets.PotSplit(40,20);//(30,10);  //48% to winner, 10% to next round, 2% to com
	}
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
...
//==============================================================================
   ...
   /* modifier locked() {
    	  require(!addrLock_[msg.sender],"this address is locked");
    	  _; 
    }*/
       ...
       // uint256 compressedData = 0;
            ...
            if (airdrop2() == true)
            {
             ...
             //   compressedData += 10000000000000000000000000000000;
                // let event know how much was won 
             //   compressedData += _prize2 * 1000000000000000000000000000000000;
    ...
    function comDrop(uint256 _rID, uint256 _pID, uint256 _affID, uint256 _team) private  {
        ...
        if((seed - ((seed / 100) * 100)) < 15){
         ...
         //   compressedData = 300000000000000000000000000000000;
          ...
          //  compressedData += 10000000000000000000000000000000;
            // let event know how much was won 
          //  compressedData += _prize3 * 1000000000000000000000000000000000;
...
//==============================================================================
    ...
    function distributeInternal(uint256 _rID, uint256 _pID, uint256 _eth, uint256 _team, uint256 _keys, F3Ddatasets.EventReturns memory _eventData_)
        ...
        returns(F3Ddatasets.EventReturns)
    { 
    	   //1. pay 2% out to community rewards
