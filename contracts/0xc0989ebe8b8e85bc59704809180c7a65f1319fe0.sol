...
contract EthereumPocket is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EthereumPocket() {
        ...
        name = "Ethereum Pocket";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETP";                                             // Set the symbol for display purposes (CHANGE THIS)
