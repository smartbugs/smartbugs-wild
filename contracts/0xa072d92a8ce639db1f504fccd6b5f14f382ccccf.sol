...
contract WhitePrivilegeToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WhitePrivilegeToken() {
        ...
        name = "WhitePrivilegeToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WPT";                                             // Set the symbol for display purposes (CHANGE THIS)
