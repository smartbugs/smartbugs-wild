...
contract VestingHuobiNext is VestingBase {
    using SafeMath for uint256;
    ...
    constructor(CovaToken _cova, uint256 _releaseTime) public {
        ...
        beneficiaryAddress = 0x46c5d4f7aC3B23d7a87fff737d4a5a65C54A6b5F;
        totalClaimable = 260000000 * (10 ** 18);
        beneficiaryClaims.push(Claim(true, 10000, 0, false));
    }
}