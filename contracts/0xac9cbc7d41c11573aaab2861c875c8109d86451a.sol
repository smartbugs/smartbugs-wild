...
contract DietEthereum is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DietEthereum() {
        ...
        name = "DietEthereum";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DETH";                                             // Set the symbol for display purposes (CHANGE THIS)
