...
contract zombittoken is StandardToken {

    function zombittoken() public { 
    ...
    */
    string public name = "zombittoken";
    string public symbol = "ZBS";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 888888 * (10 ** decimals);
    ...
    string public DigestCode_root = "fa392a3dea913d820d2b359f282863b9475adec8911b3437a0c147da5493afb5";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/7fe26681814ae97b34289283125b54e90b0ba8befacef30bd037b475766a3871/"; }
