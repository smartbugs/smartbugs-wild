...
contract erc20CTH is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function erc20CTH() {
        ...
        name = "CryptoHit";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CTH";                                             // Set the symbol for display purposes (CHANGE THIS)
