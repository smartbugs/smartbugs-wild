...
contract TTOH is owned, SafeMath {
    ...
    uint constant valueTotal = 10 * 10000 * 10000 * 10 ** 8;	//A total of two hundred million
    uint constant valueSale = valueTotal / 100 * 30;  // sell 30%
    uint constant valueTeam = valueTotal / 100 * 70;   // team 70%
