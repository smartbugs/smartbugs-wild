...
contract WhaleToken is StandardToken {
    ...
    */
    string public name = "WhaleToken";
    string public symbol = "WTCC";
    uint public decimals = 3;
    uint public INITIAL_SUPPLY = 500 * (10 ** decimals);
    string public Image_root = "undefined";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/1fec81de2358bb401f583cf08a8a33f18978343a8c0c629b0d0f7180e28da002/";
    string public DigestCode_root = "1bcc115bdb31120fc6e52d35c0a392fadee62deb709394a3c9e529d209257789";
    function getIssuer() public view returns(string) { return  "Josh Rager"; }
    function getSource() public view returns(string) { return  "WhaleTokenInc"; }
