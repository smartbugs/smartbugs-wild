...
/**
 * @notes ERC20 token for RANLYTICS Fund raising. Each token represents 1 share in RANLYTICS HOLDING Company
 */
...
/**
 * @title ERC20 token contract of RANLYTICS
 */
contract ERC20Token is ERC20, ERC20Detailed, Ownable, ERC20Burnable {
  ...
  /**
    ...
    */
  constructor () public ERC20Detailed("RANLYTICS", "RAN", DECIMALS) {
