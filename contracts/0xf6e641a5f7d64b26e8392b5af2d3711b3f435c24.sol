...
contract Coti is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Coti() {
        ...
        name = "Coti";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "COTI";                                             // Set the symbol for display purposes (CHANGE THIS)
