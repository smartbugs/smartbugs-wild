...
contract GoodManPro is StandardToken {

    function GoodManPro() public { 
    ...
    */
    string public name = "GoodManPro";
    string public symbol = "GMPC_101";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 550000 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/ad014ab0fe0542d87e78f74ea5c01b232a9ca4cd87e9e6ac62459f0e0078f2c3/";
    string public Note_root = "";
    string public DigestCode_root = "f0edea1c43b882ecb225f59ced8b002ab2711e573611e5133a1ba6a1fc406281";
    function getIssuer() public view returns(string) { return  "undefined"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/9b804e95b40ef99bfda3cfb96990467255d634af41142350147607ffd4268017/"; }
