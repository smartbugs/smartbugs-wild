...
contract BankcoinBCASH {
    ...
    function BankcoinBCASH() public {
        totalSupply = BankcoinBCASHSupply * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;    // Give BankcoinBCASHet Mint the total created tokens
        creator = msg.sender;
    }
    /**
    ...
    function () payable internal {
        ...
        balanceOf[creator] -= amount;                        // sends ETH to BankcoinBCASHNet Mint
