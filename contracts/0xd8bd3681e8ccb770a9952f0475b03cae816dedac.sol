...
contract frequency is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function frequency() {
        ...
        name = "frequency";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FREQ";                                             // Set the symbol for display purposes (CHANGE THIS)
