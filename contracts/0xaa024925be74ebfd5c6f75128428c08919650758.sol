...
contract EthereumTitan is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EthereumTitan() {
        ...
        name = "EthereumTitan";                                   // Set the name for display purposes (CHANGE THIS)
