...
contract BikeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BikeTestCoin() {
        ...
        name = "BikeTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 3;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BKTC";                                             // Set the symbol for display purposes (CHANGE THIS)
