...
contract UNITDummyPaymentGateway is Administrated {
    UNITv2 public token;
    ...
    function delegateTokens(address tokenHolder, uint96 numTokens)
        public
        onlyAdministrator
    {
        require(locked == false);

        Payment(tokenHolder, 0, 0, numTokens);

        token.delegateTokens(tokenHolder, numTokens);
