...
contract logisticstoken is StandardToken {
    ...
    */
    ...
    function logisticstoken() {
        balances[msg.sender] = 6800000000000000;               // Give the creator all initial tokens
        totalSupply = 6800000000000000;                        // Update total supply
        name = "logisticstoken";                                   // Set the name for display purposes
