...
contract CMGG12StandardToken is StandardToken { 
    ...
    string public version = 'CMGG120.1';    //版本

    function CMGG12StandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
