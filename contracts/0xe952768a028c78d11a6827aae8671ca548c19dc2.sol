...
contract Bitloanex is StandardToken {
    ...
    */
    string public name = 'Bitloanex';                   //fancy name: eg Simon Bucks
    ...
    string public symbol = 'BTLX';                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function Bitloanex(
        ...
        name = "Bitloanex";                                   // Set the name for display purposes
        decimals = 8;                            // Amount of decimals for display purposes
        symbol = "BTLX";                               // Set the symbol for display purposes
    }
