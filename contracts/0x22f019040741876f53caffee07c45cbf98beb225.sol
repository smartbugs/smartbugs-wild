...
contract BucoTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BucoTestCoin() {
        ...
        name = "BucoTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BUC";                                             // Set the symbol for display purposes (CHANGE THIS)
