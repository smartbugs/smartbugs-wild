...
/**
 * @title LuckyWorldCupSpecs
 * @dev the interface of LuckyWorldCupSpecs
 */
contract LuckyWorldCupSpecs {
...
contract LuckyWorldCupToken is ERC20,LuckyWorldCupSpecs,Ownable {
    using SafeMath for uint256;

    string public name = "LuckyWorldCup";
    ...
    function LuckyWorldCupToken() {
        maxTotalSupply = 10**26; // 100 Mil.
        totalInitialSupply = 10**25; // 10 Mil.
