...
contract DSAuth is DSAuthEvents {
    ...
    constructor() public {
        owner = 0x233EA820Bce6b2Ab072Eccc733Cc36cD02C96AEa;
        emit LogSetOwner(0x233EA820Bce6b2Ab072Eccc733Cc36cD02C96AEa);
    }

    function setOwner(address owner_0x233EA820Bce6b2Ab072Eccc733Cc36cD02C96AEa)
        public
        auth
    {
        owner = owner_0x233EA820Bce6b2Ab072Eccc733Cc36cD02C96AEa;
...
contract TheTransact is DSTokenBase , DSStop {

    string  public  symbol="TTXT";
    string  public  name="The Transact";
    uint256  public  decimals = 3; // Standard Token Precision
    uint256 public initialSupply=200000000000;
    address public burnAdmin;
    constructor() public
    DSTokenBase(initialSupply)
    {
        burnAdmin=0x233EA820Bce6b2Ab072Eccc733Cc36cD02C96AEa;
    }
