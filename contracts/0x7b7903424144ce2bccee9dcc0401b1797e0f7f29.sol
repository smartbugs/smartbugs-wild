...
contract LifeInsuranceToken is StandardToken {
    string public name = "LifeInsuranceToken";
    string public symbol = "LT";
    uint public decimals = 18;
    uint public totalSupply = 90 * 100 * 1000 ether;

    function LifeInsuranceToken() public {
