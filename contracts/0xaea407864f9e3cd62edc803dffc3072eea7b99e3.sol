...
contract QuickCoinExchange is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function QuickCoinExchange() {
        ...
        name = "QuickCoinExchange";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 5;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "QCEX";                                             // Set the symbol for display purposes (CHANGE THIS)
