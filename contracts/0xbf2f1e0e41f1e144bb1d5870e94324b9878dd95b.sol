...
contract SUNX is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SUNX() {
        ...
        name = "SUNX";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "XNS";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 3000;                                      // Set the price of your token for the ICO (CHANGE THIS)
