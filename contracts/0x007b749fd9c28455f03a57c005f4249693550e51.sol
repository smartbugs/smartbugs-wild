...
contract TraceChain is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TraceChain() {
        ...
        name = "TraceChain";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TRX";                                             // Set the symbol for display purposes (CHANGE THIS)
