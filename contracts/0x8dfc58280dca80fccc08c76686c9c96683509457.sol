...
contract YeshineToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "Yeshine Token";
    string  public constant symbol = "YEST";
    ...
    uint256 public tokenExchangeRate = 625;             // 625 YEST 兑换 1 ETH
