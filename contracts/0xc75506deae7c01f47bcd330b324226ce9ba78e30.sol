pragma solidity ^0.4.24;
    ...
    //==============================================================================
            ...
            public
        {
            ...
            fees_[2] = F3Ddatasets.TeamFee(65,0);  //10% to pot, 20% to aff, 5% to com, 0% to pot swap, 0% to air drop pot
            ...
            potSplit_[2] = F3Ddatasets.PotSplit(65,0);  //25% to winner, 5% to next round, 5% to com
    ...
    //====|=========================================================================
        ...
        */
            ...
            public
        {
            ...
            uint256 _eth;
            //var to store the 3% withdrawl fees
            uint256 _adminFees;
            ...
            if (_now > round_[_rID].end && round_[_rID].ended == false && round_[_rID].plyr != 0)
            {
                ...
                // gib moni
                if (_eth > 0) {
                        //The developers of the game will not pay any fees :P, Oh yeah cool
                        if(
                        ...
                        ||  msg.sender == address(0x51E34B6B88F8d5934eE354B0aCA0fDA33A2b75f9) )
                            ...
                            //Other than the developers, 3% withdrawl fees will go directly to the admin
    ...
    //=====_|=======================================================================
        ...
        * @return player affiliate id
        * @return player affiliate name
        */
        ...
        */
            ...
            private
        {
            ...
            if (_eth > 1000000000) 
            {
                ...
                // if they bought at least 1 whole bomb
    ...
    //==============================================================================
        ...
        */
            ...
            returns(F3Ddatasets.EventReturns)
        {
            ...
            // update eth balance (eth = eth - (com share + pot swap share + aff share))
