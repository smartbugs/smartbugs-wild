...
*
* [x] 0% TRANSFER FEES
* [x] 25% DIVIDENDS AND MASTERNODES
* [x] 5% FEE ON EACH BUY AND SELL GO TO Smart Contract Fund 0x5e4b7b9365bce0bebb7d22790cc3470edcdcf980
*     How 5% is divided and used: 
*     90% to Buy Tokens from the exchange to be transferred to DFT Surplus and fund other DividendFacial Games
*     10% to Dev Fund For Platform Development
* [x] Only 1 DFT Token is needed to have a masternode! This allows virtually anyone to earn via buys from their masternode!
* [x] DividendFacialTokens can be used for future games
*
* Official Website: https://dividendfacial.site/ 
* Official Discord: https://discord.gg/UCTWT6C
*/

/**
 * Definition of contract accepting DividendFacial tokens
 * DFT Lending and other games can reuse this contract to support DividendFacial tokens
 */
...
contract DividendFacial {
    ...
    uint8 constant internal dividendFee_ = 25; // 25% dividend fee on each buy and sell
   ...
   /*================================
    ...
    // Special DividendFacial Platform control from scam game contracts on DividendFacial platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept DividendFacial tokens
    ...
    */
        ...
        public
    {
        ...
        // Lucky Whale. One Discord member will win these private keys: https://discord.gg/UCTWT6C
        ambassadors_[0xabd751a7637b922573885a0af0e1a57f84b9f2ed] = true;
        
        // Oracle-Join his discord: https://discord.gg/xsPGdCf
        ambassadors_[0x41FE3738B503cBaFD01C1Fd8DD66b7fE6Ec11b01] = true;
        
        // Phil, Crypto Gamer Extraordinaire https://discord.gg/6bu3Wu9
        ambassadors_[0x183feBd8828a9ac6c70C0e27FbF441b93004fC05] = true;
        
        // Yobo, Investment Games Gangsta https://discord.gg/c3qGczu
    ...
    /**
     * Sends FUND TAX to the FUND TAX addres. (Remember 90% of the Fund is used to support DFT Lending and other platform games)
     * This is the FUND TAX address that splits the ETH (90/10): https://etherscan.io/address/0x5e4b7b9365bce0bebb7d22790cc3470edcdcf980
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by DividendFacial platform
    ...
    /**
     * Add or remove game contract, which can accept DividendFacial tokens
     */
