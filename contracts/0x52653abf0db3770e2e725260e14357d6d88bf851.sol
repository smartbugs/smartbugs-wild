...
contract Zawarudo is StandardToken {

    function Zawarudo() public { 
    ...
    */
    string public name = "Zawarudo";
    string public symbol = "Zw";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 21000000 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/094ae7ac656ae85135551ae284aff9ea3011c35d10e9975710a99ce30ff3b8a9/";
    string public Note_root = "";
    string public DigestCode_root = "d015a167ba071cdeffd47cb877a708158473c39a2cd4a5fef8bc54d055a7598d";
    function getIssuer() public view returns(string) { return  "diobrando"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/be4a368265fcb9dbd27caf10b5062e469868491409fe9b16cfded3ef6bbabe28/"; }
