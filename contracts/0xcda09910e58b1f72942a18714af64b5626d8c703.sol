...
contract BitcoinNetwork is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    string public name ='Bitcoin Network';                   // Token Name
    uint8 public decimals =18;                // How many decimals to show. To be standard complicant keep it 18
    string public symbol ='BNT';                 // An identifier: eg SBX, XPR etc..
    string public version = 'H1.0';
    uint256 public unitsOneEthCanBuy =10000000;     // How many units of your coin can be bought by 1 ETH?
    uint256 public totalEthInWei =150000000000;         // WEI is the smallest unit of ETH (the equivalent of cent in USD or satoshi in BTC). We'll store the total ETH raised via our ICO here.
    address public fundsWallet =0x28Adee86b609B7eA2ED393edcEa8f8ec40d9a7A7;           // Where should the raised ETH go?
    ...
    function BitcoinNetwork() {
        ...
        name = "Bitcoin Network";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BNT";                                             // Set the symbol for display purposes (CHANGE THIS)
