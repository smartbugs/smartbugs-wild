...
// ----------------------------------------------------------------------------
// 'Artcoin' contract with following features
...
// ICO reserve : 30,000,000,000   (30 Billion)
// Decimals    : 18
//
...
// ----------------------------------------------------------------------------
    ...
    contract TokenERC20 {
        ...
        constructor (
            ...
            uint256 reservedForICO = 30000000000 * (1 ether);   // Reserved for ICO - 30 Billion
            balanceOf[this] = reservedForICO;
            balanceOf[msg.sender] = totalSupply.sub(reservedForICO); // Give the creator initial tokens
