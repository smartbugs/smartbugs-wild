...
contract Moneyplant is StandardToken, Owned { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Moneyplant() {
        ...
        name = "Moneyplant";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;             	                                  // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MPX";                                             // Set the symbol for display purposes (CHANGE THIS)
