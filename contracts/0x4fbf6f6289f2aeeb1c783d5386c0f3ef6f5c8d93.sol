...
//****************
    ...
    mapping (uint256 => X3Ddatasets.Player) public plyr_;   // (pID => data) player data
    mapping (uint256 => mapping (uint256 => X3Ddatasets.PlayerRounds)) public plyrRnds_;    // (pID => rID => data) player round data by player id & round id
    mapping (uint256 => mapping (bytes32 => bool)) public plyrNames_; // (pID => name => bool) list of names a player owns.  (used so you can change your display name amongst any name you own)
//****************
// ROUND DATA 
//****************
    mapping (uint256 => X3Ddatasets.Round) public round_;   // (rID => data) round data
    mapping (uint256 => mapping(uint256 => uint256)) public rndTmEth_;      // (rID => tID => data) eth in per team, by round id and team id
//****************
// TEAM FEE DATA 
//****************
    mapping (uint256 => X3Ddatasets.TeamFee) public fees_;          // (team => fees) fee distribution by team
    mapping (uint256 => X3Ddatasets.PotSplit) public potSplit_;     // (team => fees) pot split distribution by team
//==============================================================================
...
//==============================================================================
        ...
        public
    {
        ...
        fees_[0] = X3Ddatasets.TeamFee(30,6);   //50% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[1] = X3Ddatasets.TeamFee(43,0);   //43% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[2] = X3Ddatasets.TeamFee(56,10);  //20% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        fees_[3] = X3Ddatasets.TeamFee(43,8);   //35% to pot, 10% to aff, 2% to com, 1% to pot swap, 1% to air drop pot
        
      
        potSplit_[0] = X3Ddatasets.PotSplit(15,10);  //48% to winner, 25% to next round, 2% to com
        potSplit_[1] = X3Ddatasets.PotSplit(25,0);   //48% to winner, 25% to next round, 2% to com
        potSplit_[2] = X3Ddatasets.PotSplit(20,20);  //48% to winner, 10% to next round, 2% to com
        potSplit_[3] = X3Ddatasets.PotSplit(30,10);  //48% to winner, 10% to next round, 2% to com
	}
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
...
//==============================================================================
    ...
    /**
     * @dev prevents contracts from interacting with x3d 
     */
    modifier isHuman() {
...
//==============================================================================
    ...
    {
        uint256 _pID = pIDxAddr_[msg.sender];
        // if player is new to this version of x3d
        if (_pID == 0)
        {
    ...
    /**
     * @dev distributes eth based on fees to com, aff, and XCOM
     */
        ...
        returns(X3Ddatasets.EventReturns)
    {
        ...
        // update eth balance (eth = eth - (com share + pot swap share + aff share + XCOM share + airdrop pot share))
...
library X3Ddatasets {
    ...
    struct EventReturns {
        ...
        uint256 XCOMAmount;          // amount distributed to XCOM
    ...
    struct TeamFee {
        ...
        uint256 XCOM;    // % of buy in thats paid to XCOM holders
    }
    struct PotSplit {
        uint256 gen;    // % of pot thats paid to key holders of current round
        uint256 XCOM;    // % of pot thats paid to XCOM holders
    }
}
