...
contract DoggyToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DoggyToken() {
        ...
        name = "Doggy Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DOG";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 7220;                                      // Set the price of your token for the ICO (CHANGE THIS)
