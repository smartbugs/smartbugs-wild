...
contract KawaiiCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KawaiiCoin() {
        ...
        name = "KawaiiCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "kwc";                                             // Set the symbol for display purposes (CHANGE THIS)
