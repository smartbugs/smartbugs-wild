...
contract Chromia is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Chromia() {
        ...
        name = "Chromia";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CHR";                                             // Set the symbol for display purposes (CHANGE THIS)
