...
/// @notice SEEDCrowdsale has 2 phases for crowdsale.
...
contract SEEDCrowdsale is Ownable, CanReclaimToken, Pausable {
  ...
  /// @notice buyTokens process token purchase.
  ...
  /// @notice finalize token sale. Tokens for specific holders are generated.
