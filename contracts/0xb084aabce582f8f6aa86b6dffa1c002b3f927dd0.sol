...
contract TranslationService is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TranslationService() {
        ...
        name = "TranslationService";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TRC";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 120000;                                      // Set the price of your token for the ICO (CHANGE THIS)
