 ...
 */
contract FreePPCoin is StandardToken {

  string public constant name = "FreePPCoin"; 
   ...
   */
  function FreePPCoin() public {
    // constructor
    totalSupply_ = INITIAL_SUPPLY; 
    balances[msg.sender] = INITIAL_SUPPLY ;//do not remove
