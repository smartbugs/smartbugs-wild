...
contract Aurora_v1a is StandardToken {

    function Aurora_v1a() public { 
    ...
    */
    string public name = "Aurora_v1a";
    string public symbol = "Av1a";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 290 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/30dd443aee61eba410be4597f89cf33bd8f7c2d0a32429a22de71b3b45936fb1/";
    string public Note_root = "";
    string public DigestCode_root = "95137d600ecfb31cc5bbff67c2b2664e0f97a276719b08d5d03c3bf7daadbd3f";
    function getIssuer() public view returns(string) { return  "Aurora"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/30be93ba427c2f5d494f93c80b1588d92396814d68c5ec387ce700469d1e1d91/"; }
