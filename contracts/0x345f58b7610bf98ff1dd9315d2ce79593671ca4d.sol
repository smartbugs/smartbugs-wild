...
contract Neptun {
    ...
    function Neptun() public {
        totalSupply = NeptunSupply * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;    // Give NeptunCoin Mint the total created tokens
        creator = msg.sender;
    }
    /**
