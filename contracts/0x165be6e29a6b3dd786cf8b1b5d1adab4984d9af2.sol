...
contract CoinBtgl // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x2ae3c94a773595c9432892e8bb567ec200395221; // @eachvar
    address public account_address = 0x2ae3c94a773595c9432892e8bb567ec200395221; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "Bitdog Coin"; // @eachvar
    string public symbol = "BTGL"; // @eachvar
