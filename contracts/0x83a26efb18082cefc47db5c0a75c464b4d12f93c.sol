...
contract BitcoinSamaritan {
   ...
   function BitcoinSamaritan() public {
        totalSupply = BitcoinSamaritanSupply * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;    // Give BitcoinSamaritan Mint the total created tokens
        creator = msg.sender;
    }
    /**
