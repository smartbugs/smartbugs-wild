...
contract SCFToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SCFToken() {
        ...
        name = "SupplyChainFinance";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 3;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SCF";                                             // Set the symbol for display purposes (CHANGE THIS)
