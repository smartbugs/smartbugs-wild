...
contract persua is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function  persua() {
        ...
        name = "persua";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "persua";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy =  12000000;                                      // Set the price of your token for the ICO (CHANGE THIS)
