...
contract Zinoder is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EtherXeum() {
        ...
        symbol = "ZIR";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 6000000;                                      // Set the price of your token for the ICO (CHANGE THIS)
