...
/*
Full name TaiCoin abbreviation TaiCoin

Total ten million pieces.
 
TaiCoin pledges to 6.5 times the specified wallet address and releases MFC at 0.2% per day; the released token (MFC) is repeatedly pledged to 7 times the interest rate; the community shares 80% of the contribution award; TaiCoin burns 20% MFC; 1TaiCoin = 0.3 US dollars, and the total MFC issue is $10 billion.
*/
contract TaiCoin is StandardToken, Ownable {
    // Constants
