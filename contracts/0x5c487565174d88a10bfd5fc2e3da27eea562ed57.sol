...
//****************
    ...
    mapping (uint256 => RP1datasets.Player) public plyr_;   // (pID => data) player data
    mapping (uint256 => mapping (uint256 => RP1datasets.PlayerRounds)) public plyrRnds_;    // (pID => rID => data) player round data by player id & round id
    mapping (uint256 => mapping (bytes32 => bool)) public plyrNames_; // (pID => name => bool) list of names a player owns.  (used so you can change your display name amongst any name you own)
//****************
// ROUND DATA 
//****************
    mapping (uint256 => RP1datasets.Round) public round_;   // (rID => data) round data
    mapping (uint256 => mapping(uint256 => uint256)) public rndTmEth_;      // (rID => tID => data) eth in per team, by round id and team id
//****************
// TEAM FEE DATA 
//****************
    mapping (uint256 => RP1datasets.TeamFee) public fees_;          // (team => fees) fee distribution by team
    mapping (uint256 => RP1datasets.PotSplit) public potSplit_;     // (team => fees) pot split distribution by team
//==============================================================================
...
//==============================================================================
    ...
    public
    {
        ...
        //土星 计算的 100-30-18
        fees_[0] = RP1datasets.TeamFee(30,0);   //52% to pot, 12% to aff, 2% to com, 1% to pot swap, 3% to air drop pot
        //木星
        fees_[1] = RP1datasets.TeamFee(41,0);   //41% to pot, 12% to aff, 2% to com, 1% to pot swap, 3% to air drop pot
        //火星
        fees_[2] = RP1datasets.TeamFee(60,0);   //22% to pot, 12% to aff, 2% to com, 1% to pot swap, 3% to air drop pot
        //地球
        fees_[3] = RP1datasets.TeamFee(46,0);   //36% to pot, 12% to aff, 2% to com, 1% to pot swap, 3% to air drop pot

        // (分红, 推广经费)
        potSplit_[0] = RP1datasets.PotSplit(32,0);  //47% to winner, 18% to next round, 3% to com
        potSplit_[1] = RP1datasets.PotSplit(25,0);  //47% to winner, 15% to next round, 3% to com
        potSplit_[2] = RP1datasets.PotSplit(35,0);  //47% to winner, 10% to next round, 3% to com
        potSplit_[3] = RP1datasets.PotSplit(44,0);  //47% to winner,  6% to next round, 3% to com
    }
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
...
//=====================_|=======================================================
    ...
    private
    {
        ...
        // early round eth limiter 100eth 1eth
...
//==============================================================================
    ...
    returns (RP1datasets.EventReturns)
    {
        ...
        // rp1 share, and amount reserved for next pot 
...
library RP1datasets {
    ...
    struct EventReturns {
        ...
        uint256 rp1Amount;          // amount distributed to rp1
    ...
    struct TeamFee {
        ...
        uint256 rp1;    // % of buy in thats paid to rp1 holders
    }
    struct PotSplit {
        uint256 gen;    // % of pot thats paid to key holders of current round
        uint256 rp1;    // % of pot thats paid to rp1 holders
    }
}
