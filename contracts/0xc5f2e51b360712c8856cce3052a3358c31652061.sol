...
contract Insureum is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Insureum() {
        ...
        name = "Insureum";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "INSR";                                             // Set the symbol for display purposes (CHANGE THIS)
