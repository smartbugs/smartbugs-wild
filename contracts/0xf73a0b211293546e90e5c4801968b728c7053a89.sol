...
contract migao is StandardToken {

    function migao() public { 
    ...
    */
    string public name = "migao";
    string public symbol = "Mgao";
    ...
    string public DigestCode_root = "b42927596a1e0057acf3bfc4689f3bc7654f64b0d70601892a06eed8daa0730c";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/2683931a784aa44202042d6c3d01572a7dd536d2a7cdbdcb6432cdf6be68ec4f/"; }
