...
contract SpiderStore2018Contributions is ERC721Token, Ownable {
    constructor (string _name, string _symbol) public ERC721Token(_name, _symbol)
    {
        ...
        super._setTokenURI(1, 'https://ipfs.io/ipfs/QmfDJCNDZiMqpSizWK5GoBThFHinhq68nicu9ntNMawEBb');

        super._mint(msg.sender, 2);
        super._setTokenURI(2, 'https://ipfs.io/ipfs/QmNqfRD2SZn4EeTzuZ7wpqxcj3ikN32NXfdSQu8RViUkyZ');
    }
