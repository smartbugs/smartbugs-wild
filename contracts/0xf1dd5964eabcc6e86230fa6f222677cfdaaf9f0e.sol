...
contract ThemisToken is Ownable, StandardToken {
  ...
  uint256 public foundationSupply;                       // Foundation/Community supply
  uint256 public teamSupply;                             // Team supply
  uint256 public marketingSupply;                        // Marketing & strategic supply
  uint256 public optionSupply;                           // Option supply

  address public angelAddress;                           // Angel address
  address public earlyBirdsAddress;                      // Early Birds address
  ...
  address public optionAddress;                          // Option address
  ...
  function ThemisToken() public {
    ...
    angelSupply         =   300000000 * 1e18;             //  10% -  for private angels sale
    earlyBirdsSupply    =   600000000 * 1e18;             //  20% -  for early-bird sale
    teamSupply          =   450000000 * 1e18;             //  15% -  for team
    foundationSupply    =   750000000 * 1e18;             //  25% -  for foundation/incentivising efforts
    marketingSupply     =   600000000 * 1e18;             //  20% -  for covering marketing and strategic expenses
    optionSupply        =   300000000 * 1e18;             //  10% -  for option

    angelAddress         = 0xD58aE13Eb1e8CDb92088709A6868d32C993FAd74;  // Angel address
    earlyBirdsAddress    = 0xac9EaB9C4c403441fb8592529A3cE534E68246ED;  // Early Birds address
    teamAddress          = 0x4d06220df2BC77C3E47b72611AA79915611Ed23B;  // Team address
    foundationAddress    = 0xDa2AB3712A490cC6Df661E3ae398BeA24434349F;  // Foundation/Community address
    marketingAddress     = 0x9f160Ed0F3B8d5180Eb5cC97c43CF7Fe1efFE02C;  // Marketing/Strategic address
    optionAddress        = 0x47343c223F3605aC541a8eC61e5Fd41EBDdEc9d1;  // Option address
