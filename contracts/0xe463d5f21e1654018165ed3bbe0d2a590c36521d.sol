...
// File: contracts/TdToken.sol

/*
 * TdToken is a standard ERC20 token with some additional functionalities:
...
contract TdToken is StandardToken, BurnableToken, Ownable {
	...
	uint256 public constant INITIAL_SUPPLY = 960000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 384000000000 * (10 ** uint256(decimals));
	...
	*/
	function TdToken(address admin) public {
	...
	* @param value Amount of tdtokens to send
	*/
