...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[1] memory weiRaisedEndsBounds = [uint(333373373733333333333333)];
        uint64[1] memory timeStartsBounds = [uint64(1562558400)];
        uint64[1] memory timeEndsBounds = [uint64(1577848555)];
        ...
        // apply amount
        uint[2] memory weiAmountBounds = [uint(6666000000000000000000),uint(10000000000000000000)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(15000 * TOKEN_DECIMAL_MULTIPLIER, 0x2DE48A617A600be6489E1f42251e4789a09D7E23, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1577848560)
        CappedCrowdsale(333373373733333333333333)
    ...
    function init() public onlyOwner {
        ...
        address[4] memory addresses = [address(0x7c85c931a07917840b19f03bd32d13f4b1c1309a),address(0xeac9314457d66eac79d47b0f79184150b3c320e4),address(0x96cae4c6504ad6a3514e358a025a8bc464022b45),address(0x5010f4bc87910ab5ba7286cd29767487c5ec2ee3)];
        uint[4] memory amounts = [uint(199999400000000000000000000),uint(200000000000000000000000000),uint(100000000000000000000000000),uint(500000000000000000000000000)];
     ...
     */
    function hasClosed() public view returns (bool) {
        bool remainValue = cap.sub(weiRaised) < 30000000000000000;
        ...
        internal
    {
        ...
        require(msg.value <= 6666000000000000000000);
