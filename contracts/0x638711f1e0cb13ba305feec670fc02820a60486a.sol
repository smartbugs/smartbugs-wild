...
contract Etherbuxx is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Etherbuxx() {
        ...
        name = "Etherbuxx";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETBX";                                             // Set the symbol for display purposes (CHANGE THIS)
