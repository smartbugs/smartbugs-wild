...
contract AnimalFoodToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AnimalFoodToken() {
        ...
        name = "AnimalFoodToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AFT";                                             // Set the symbol for display purposes (CHANGE THIS)
