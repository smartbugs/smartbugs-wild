...
contract BitBill is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BitBill() {
        ...
        name = "BitBill";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTB";                                             // Set the symbol for display purposes (CHANGE THIS)
