...
contract XGoldToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function XGoldToken() {
        ...
        name = "XGoldToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "XGT";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 189000000;                                      // Set the price of your token for the ICO (CHANGE THIS)
