...
contract AwarenessToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AwarenessToken() {
        ...
        name = "AwarenessToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 12;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "OAI";                                             // Set the symbol for display purposes (CHANGE THIS)
