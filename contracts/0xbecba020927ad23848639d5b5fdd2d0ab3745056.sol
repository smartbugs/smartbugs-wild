...
contract MomoToken is StandardToken, SafeMath {
 
    // metadataKKCoin
    string  public constant name = "Momo";
    string  public constant symbol = "MomoCoin";
    ...
    uint256 public tokenExchangeRate = 500;             // 625 BILIBILI 兑换 1 ETH
