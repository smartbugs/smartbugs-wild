...
// Gōrudo ゴールド contract

// Mineable ERC20 Token No Hash Power
...
contract Gorudo {
    string public symbol = "GRDO";
    string public name = "Gōrudo ゴールド";
    uint8 public constant decimals = 8;
    uint256 _totalSupply = 0;
	uint256 _maxTotalSupply = 2100000000000000;
	uint256 _adminsupply = 150000000000000;//Admin Supply of 1.5 Million Coins
	uint256 _miningReward = 10000000000; //1 GRDO - To be halved every 4 years
	uint256 _maxMiningReward = 1000000000000; //50 GRDO - To be halved every 4 years
	uint256 _rewardHalvingTimePeriod = 126227704; //4 years
	uint256 _nextRewardHalving = now + _rewardHalvingTimePeriod;
	uint256 _rewardTimePeriod = 150; //10 minutes
	uint256 _AdminSupplyTime = 150; //20 minutes
