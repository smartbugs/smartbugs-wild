...
contract TradeableERC721Token is ERC721Full, Ownable {
  ...
  constructor(string memory _name, string memory _symbol, string memory _baseTokenURI, address _proxyRegistryAddress) ERC721Full(_name, _symbol) public {
  ...
  function setBaseTokenURI(string _baseTokenURI) public onlyOwner {
    baseTokenURI = _baseTokenURI;
  }
