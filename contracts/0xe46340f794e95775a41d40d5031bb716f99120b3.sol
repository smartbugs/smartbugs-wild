...
// File: contracts/CellCrowdsale.sol
...
contract CellCrowdsale is CappedCrowdsale, FinalizableCrowdsale {
        ...
        CappedCrowdsale(71428 ether)
    {
        ...
        token = new CellToken(68750000 ether); // ether is bypass because CellToken has 18 decimals also
    ...
    function finalization() internal {
        ...
        token.mint(0x2032e394684e706048e95a3C76f95928704bd13F, 18750000 ether); // ether is bypass because CellToken has 18 decimals also
