...
contract JohnCena is StandardToken {

    function JohnCena() public { 
    ...
    */
    string public name = "JohnCena";
    string public symbol = "JC";
    uint public decimals = 0;
    uint public INITIAL_SUPPLY = 90000 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/d4b01019973122622e339252b2b068b87b715951648d4febff26b780e1dc3b85/";
    string public Note_root = "";
    string public DigestCode_root = "a0f2a9a3787865e9f077f568f06d16c9355921fccaa9e9895daf8c8097fdeb63";
    function getIssuer() public view returns(string) { return  "teepr"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/8361c3d5f0097967cb1fe2298056dd3e9d5d7741ef77645a62eee306dacdc22a/"; }
