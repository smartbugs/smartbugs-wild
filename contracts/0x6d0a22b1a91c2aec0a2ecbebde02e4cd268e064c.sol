...
contract ACT is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ACT() {
        ...
        name = "Advanced Crypto Technology";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ACT";                                             // Set the symbol for display purposes (CHANGE THIS)
