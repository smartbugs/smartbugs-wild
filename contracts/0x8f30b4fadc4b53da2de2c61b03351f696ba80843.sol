...
contract Shefo is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Shefo() {
        balances[msg.sender] = 60000000000000000000000000000;               // Give the creator all initial tokens. This is set to 1000 for example. If you want your initial tokens to be X and your decimal is 5, set this value to X * 100000. (CHANGE THIS)
        totalSupply = 60000000000000000000000000000;                        // Update total supply (1000 for example) (CHANGE THIS)
        name = "Shefo";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                                // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SFX";                                             // Set the symbol for display purposes (CHANGE THIS)
