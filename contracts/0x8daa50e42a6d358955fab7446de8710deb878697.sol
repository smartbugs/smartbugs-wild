...
contract SimpleTokenCoin is MintableToken {
    ...
    string public constant name = "Testocoini";
...
contract Crowdsale is Ownable {
    ...
    function Crowdsale() {
        multisig = 0xeEBbD0927a046fFc9392200A208D4A990F9fC001;
        restricted = 0x498B783854432a2a87213f89B14b1Faf0677edC2;
        restrictedPercent = 25;
        rate = 600000000000000000000;
        start = 1510218000;
        period = 7;
