...
//=================_|===========================================================
    ...
    uint256 public rndGap_ = 30 minutes;         // length of ICO phase, set to 1 year for EOS.
    uint256 constant public rndInit_ = 30 minutes;                // round timer starts at this
    uint256 constant public rndInc_ = 10 seconds;              // every full key purchased adds this much to the timer
    uint256 constant public rndMax_ = 1 hours;                // max length a round timer can be
//==============================================================================
//     _| _ _|_ _    _ _ _|_    _   .
