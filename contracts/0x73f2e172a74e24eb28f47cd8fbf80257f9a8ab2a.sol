...
contract Zeroexchange is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Zeroexchange() {
        ...
        name = "Zeroexchange";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ZOO";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 2200;                                      // Set the price of your token for the ICO (CHANGE THIS)
