...
contract Blockwei is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Blockwei() {
        ...
        name = "Blockwei";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BWT";                                             // Set the symbol for display purposes (CHANGE THIS)
