...
contract POSSCOIN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function POSSCOIN() {
        ...
        name = "POSSCOIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "POSS";                                             // Set the symbol for display purposes (CHANGE THIS)
