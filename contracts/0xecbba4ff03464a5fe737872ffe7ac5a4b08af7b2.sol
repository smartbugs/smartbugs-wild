...
contract KyleStandardToken is StandardToken { 
    ...
    function KyleStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
