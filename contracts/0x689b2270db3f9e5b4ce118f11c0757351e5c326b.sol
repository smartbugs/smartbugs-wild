...
contract Mether is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Mether() {
        ...
        name = "Mether";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "XMTK";                                             // Set the symbol for display purposes (CHANGE THIS)
