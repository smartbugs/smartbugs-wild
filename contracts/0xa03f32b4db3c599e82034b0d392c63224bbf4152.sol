...
contract Validus is ERC20,ValidusToken,Ownable {
    using SafeMath for uint256;

    string public name = "Validus";
    string public symbol = "IDUS";
    ...
    constructor() public {
        maxTotalSupply = 10000000000000000000000000;
        totalInitialSupply = 1000000000000000000000000;

        chainStartTime = 1539172800; //Original Time
        chainStartBlockNumber = 6482414; //Original Block
