...
contract testyayaho is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function testyayaho() {
        ...
        name = "testyayaho";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TYH";                                             // Set the symbol for display purposes (CHANGE THIS)
