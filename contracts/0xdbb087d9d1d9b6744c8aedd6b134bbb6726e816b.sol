...
//Copyright © 2017 SailersCoin LLC
contract SailorsCoin is StandardToken {
    ...
    */
    string public name;                   //fancy name: eg SailorsCoin
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function SailorsCoin(
        ...
        name = "SailorsCoin";                                   // Set the name for display purposes
        decimals = 18;                            // Amount of decimals for display purposes
        symbol = "SLCN";                               // Set the symbol for display purposes
    }
