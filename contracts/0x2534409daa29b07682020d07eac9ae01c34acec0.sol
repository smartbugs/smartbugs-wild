...
* Project Name : Miracle Token
* Platform: www.miracle.channel -> soon to be launched
* Ticker: MRCL
* Visit: www.miracletoken.org
...
contract MRCL is StandardToken, Pausable, Claimable {
  ...
  constructor() public {
    totalSupply_ = 9660000000 ether; // 966 million, 18 decimals (ether = 1^9)
