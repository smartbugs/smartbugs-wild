...
contract Dragon {
    ...
    modifier limitBuy() { 
        if(limit && msg.value > 1 ether) { // check if the transaction is over 1ether and limit is active
    ...
    */
        ...
        public
    {
        ...
        uint256 _undividedDividends = SafeMath.div(_ethereum*dividendFee_, 100); // 25% dividendFee_
    ...
    * redistribution of dividends
    ...
    {   
        ...
        // data setup
        address _customerAddress = msg.sender;
        uint256 _undividedDividends = SafeMath.div(_incomingEthereum*dividendFee_, 100); // 25% dividendFee_
