...
contract ASScoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ASScoin() {
        ...
        name = "ASScoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ASSS";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 600000;                                      // Set the price of your token for the ICO (CHANGE THIS)
