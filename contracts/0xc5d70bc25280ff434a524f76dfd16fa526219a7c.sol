...
contract ChuiniuCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ChuiniuCoin() {
        ...
        name = "ChuiniuCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 13;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CNC";                                             // Set the symbol for display purposes (CHANGE THIS)
