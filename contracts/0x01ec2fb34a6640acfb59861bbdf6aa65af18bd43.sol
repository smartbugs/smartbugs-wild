...
contract WatTestCoin4 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WatTestCoin4() {
        ...
        name = "WatTestCoin4";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WHCN4";                                             // Set the symbol for display purposes (CHANGE THIS)
