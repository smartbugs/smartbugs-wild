...
/**
  Multiplier contract: returns 105% of each investment!
  Automatic payouts!
  ...
  2. Wait a little bit
  3. ...
  4. PROFIT! You have got 105%

  How is that?
  1. The first investor in the queue (you will become the
     first in some time) receives next investments until
     it become 105% of his initial investment.
  2. You will receive payments in several parts or all at once
  3. Once you receive 105% of your initial investment you are
  ...
  5. The balance of this contract should normally be 0 because
     ...
     if the deposit big enough) and the investors paid 105% are removed from the queue
    ...
    (fully paid) investor1   <-|                   investor2   <----|  (pay until 105%)


  Контракт Умножитель: возвращает 105% от вашего депозита!
  ...
  2. Немного подождите
  3. ...
  4. PROFIT! Вам пришло 105% от вашего депозита.

  Как это возможно?
  1. Первый инвестор в очереди (вы станете первым очень скоро) получает выплаты от
     новых инвесторов до тех пор, пока не получит 105% от своего депозита
  2. Выплаты могут приходить несколькими частями или все сразу
  3. Как только вы получаете 105% от вашего депозита, вы удаляетесь из очереди
  ...
  5. Баланс этого контракта должен обычно быть в районе 0, потому что все поступления
     ...
     Таким образом, последние платят первым, и инвесторы, достигшие выплат 105% от депозита,
...
(полная выплата) инвестор1   <-|                   инвестор2   <----|  (доплата до 105%)
...
contract x105 {
    ...
    struct Deposit {
        ...
        uint128 expect;    //How much we should pay out (initially it is 105% of deposit)
    }
