...
contract DDNToken is StandardToken { 
    ...
    string public version = 'v1.0';       //版本

    function DDNToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
