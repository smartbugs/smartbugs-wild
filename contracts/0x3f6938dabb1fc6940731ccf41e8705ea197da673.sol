...
contract AirdropCompany is MintableToken, BurnableToken, PausableToken {

    string public constant name = "AirdropCompany";
    string public constant symbol = "AIRC";
    uint8 public constant decimals =0;


    function AirdropCompany() {
