...
* [x] Masternodes: Holding 100 PONS Tokens allow you to generate a Masternode link, Masternode links are used as unique entry points to the contract!
...
*
* [x] REVOLUTIONARY 0% TRANSFER FEES, NOW YOU CAN SEND PONS tokens to all your family, no charge :)
*
...
contract ProofOfNoSnipers {
    ...
    uint8 constant internal dividendFee_ = 50; // Look, strong Math 12.5% SUPER SAFE
