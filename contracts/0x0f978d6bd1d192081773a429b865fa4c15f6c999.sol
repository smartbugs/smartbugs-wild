...
/*
* Token concept
*  3% Withdraw fee - комиссия за выход
*  13% Deposit fee - комиссия за вход
*  1% Token transfer - комиссия за перевод токинов между кошельками
*  3,5% Referal link ()
*  0.5% _admin (from buy)
...
contract diamondmoney {
    ...
    uint256 public stakingRequirement = 20e18;    //сколько токенов нужно для рефералки 
