...
contract Kappa1 is StandardToken {

    function Kappa1() public { 
    ...
    */
    string public name = "Kappa1";
    string public symbol = "Kp1";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 16448 * (10 ** decimals);
    ...
    string public DigestCode_root = "0a6c2e200015ca0b93f6e10f9bd9abd83f0eb1c717630529ba06caf9f1efd07e";
    function getIssuer() public view returns(string) { return  "MuseeDuLouvre"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/a52c5c38b9aff9c7532ca3fe4df3438ccbec8b8c45f115f366a6b756c3cfb863/"; }
