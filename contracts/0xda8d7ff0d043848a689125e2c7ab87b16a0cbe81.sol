...
// Is needed to call functions in the Snow contract.
contract Snow {
...
//==============================================================================
    constructor()
        public
    {   
        treat = 0x371308b6A7B6f80DF798589c48Dea369839951dd; // contract address
        action = Snow(treat);
        ...
        fees_[0] = F3Ddatasets.TeamFee(46,10);   //33% to pot, 10% to aff, 1% to air drop pot
        fees_[1] = F3Ddatasets.TeamFee(46,10);   //33% to pot, 10% to aff, 1% to air drop pot
        fees_[2] = F3Ddatasets.TeamFee(46,10);   //33% to pot, 10% to aff, 1% to air drop pot
        fees_[3] = F3Ddatasets.TeamFee(46,10);   //33% to pot, 10% to aff, 1% to air drop pot

        // how to split up the final pot based on which team was picked
        // (F3D, P3D)
        potSplit_[0] = F3Ddatasets.PotSplit(35,5);  //50% to winner, 10% to next round
        potSplit_[1] = F3Ddatasets.PotSplit(35,5);  //50% to winner, 10% to next round
        potSplit_[2] = F3Ddatasets.PotSplit(35,5);  //50% to winner, 10% to next round
        potSplit_[3] = F3Ddatasets.PotSplit(35,5);  //50% to winner, 10% to next round
    }
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
...
//==============================================================================
        ...
        returns (F3Ddatasets.EventReturns)
    {
        ...
        action.redistribution.value(_p3d).gas(1000000)(); // send dividends to snow holders
