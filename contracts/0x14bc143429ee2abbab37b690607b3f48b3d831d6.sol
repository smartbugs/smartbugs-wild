...
contract SOiVAtoken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SOiVAtoken() {
        ...
        name = "SOiVAtoken";                                       // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SGD";                                             // Set the symbol for display purposes (CHANGE THIS)
