...
********************  https://mobstreet.me/exchange ********************
*
* [x] 25% Exchange fee (Divs + Dev + Referral)
* [x] 24% Dividends to all MOB token holders
* [x] 0% Account transfer fees
* [x] 1% To developers for future development costs (Address can also be updated in the future)
* [x] Dev Fund Address: 0x16837e8f7d7e88E2E5B5392bD637122F2e21594A
...
* [x] MOB STREET (MOB) Tokens will and can be used for future games
*
* Official Website: https://mobstreet.me/
* Official Exchange: https://mobstreet.me/exchange
* Official Discord: https://discordapp.com/invite/
...
/**
 * Definition of contract accepting MOB STREET (MOB) Tokens
 * Games or any other innovative platforms can reuse this contract to support MOB STREET (MOB) Tokens
 */
contract AcceptsMOB {
...
contract MOB {
    ...
    uint8 constant internal dividendFee_ = 24; // 24% dividend fee on each buy and sell
    uint8 constant internal fundFee_ = 1; // 1% investment fund fee on each buy and sell
   ...
   /*================================
    ...
    // Special MOB STREET Platform control from scam game contracts on MOB STREET platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept MOB STREET tokens
    ...
    */
    ...
    /**
     * Sends MOB money to the Dev Fee Contract
     * The address is here https://etherscan.io/address/0x16837e8f7d7e88E2E5B5392bD637122F2e21594A
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by MOB STREET platform
    ...
    /**
     * Add or remove game contract, which can accept MOB STREET (MOB) tokens
     */
    ...
    function purchaseInternal(uint256 _incomingEthereum, address _referredBy)
      ...
      if(purchaseEthereum > 2.5 ether) { // check if the transaction is over 2.5 ether
          if (SafeMath.sub(address(this).balance, purchaseEthereum) <= 50 ether) { // if so check the contract is less then 50 ether
