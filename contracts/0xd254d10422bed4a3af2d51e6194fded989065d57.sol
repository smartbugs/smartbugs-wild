...
contract CEROToken is PausableToken {
    string  public  constant name = "CERO Chain";
    string  public  constant symbol = "CERO";
    ...
    function CEROToken( address _admin, uint _totalTokenAmount ) 
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to CERO
