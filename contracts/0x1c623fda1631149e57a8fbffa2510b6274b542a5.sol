...
contract LaszloCoin {//is inherently ERC20
    ...
    */
    ...
    string constant public name = "LaszloCoin";

    string constant public symbol = "LZL";
    ...
    function LaszloCoin() public {balanceOf[msg.sender] = totalSupply;}
