/* 2018
* Powered by team polybius and Polymath.

Contact Official Polybius : info@polybius.io
Contact Official Polymath : sukhveer@polymath.network

* Name : Polysmart (POLYS)
* Supply :  10,000,000,000 (POLYS)


Get Token Polysmart (POLYS) by send Ethereum to Smart contract

* Send 0 Ethereum (ETH) to Smart Contract Polysmart (POLYS)
* Send Minimum 0.01 Ethereum (ETH) to get Bonus.

* Public airdrop 1 ETH : 25.000.000 Polysmart (POLYS)

* 0.01 Ethereum (ETH) Bonus 10/100 (10%)
* 0.1  Ethereum (ETH) Bonus 30/100 (30%)
* 1    Ethereum (ETH) Bonus 100/100 (100%)

* Gas limit 100,000

Holders Polysmart will get Polymath ratio 100 : 1
Example : You hold 100 Polysmart (POLYS) you will get 1 Polymath (POLY)

Website launch January 2019.
