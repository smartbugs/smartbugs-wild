...
/**
 * @title CityTokenCrowdsale
 */
contract CityTokenCrowdsale is CappedCrowdsale {


  function CityTokenCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, uint256 _cap, address _wallet, address _token, uint256 _maxWei) public
