...
/**
 * @title AI42TOKEN
 * @dev A ERC20 Token which maps the AI42 ETI, where all tokens are pre-assigned to the creator.
 * Note they can later distribute these tokens as they wish using `transfer` and other
 * `ERC20` functions.
 */
contract AI42TOKEN is ERC20, ERC20Detailed {
    uint256 public constant INITIAL_SUPPLY = 65000000 * (10 ** uint256(decimals()));
    uint256 AI42IndexValue;
    address Issuer;
    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("AI42 INDEX Token", "AI42", 0) {
