...
/**
 * @title Bigbull
 * @dev The Bigbull ERC20 contract
 */
contract Bigbull is StandardToken, Burnable, Claimable {

  string public constant name = "Bigbull"; // solium-disable-line uppercase
  string public constant symbol = "BBC"; // solium-disable-line uppercase
