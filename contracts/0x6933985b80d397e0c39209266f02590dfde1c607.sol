...
contract DSAuth is DSAuthEvents {
    ...
    constructor() public {
        owner = 0xd17317A068884CaF6A7E16A2A5C4F76aDC35632F;
        emit LogSetOwner(0xd17317A068884CaF6A7E16A2A5C4F76aDC35632F);
    }

    function setOwner(address owner_0xd17317A068884CaF6A7E16A2A5C4F76aDC35632F)
        public
        auth
    {
        owner = owner_0xd17317A068884CaF6A7E16A2A5C4F76aDC35632F;
...
contract USGlobalcoin is DSTokenBase , DSStop {

    string  public  symbol="USG";
    string  public  name="USGlobalcoin";
    uint256  public  decimals = 18; // Standard Token Precision
    uint256 public initialSupply=21000000000000000000000000000;
    address public burnAdmin;
    constructor() public
    DSTokenBase(initialSupply)
    {
        burnAdmin=0xd17317A068884CaF6A7E16A2A5C4F76aDC35632F;
    }
