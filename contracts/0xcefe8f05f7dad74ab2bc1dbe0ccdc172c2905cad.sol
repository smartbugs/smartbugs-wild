...
contract Hype is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Hype() {
        ...
        name = "Hype";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HYPE";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 140000;                                      // Set the price of your token for the ICO (CHANGE THIS)
