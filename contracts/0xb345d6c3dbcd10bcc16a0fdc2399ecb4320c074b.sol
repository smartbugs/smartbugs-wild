...
contract TRNCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TRNCoin() {
        ...
        name = "TRN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TRN";                                             // Set the symbol for display purposes (CHANGE THIS)
