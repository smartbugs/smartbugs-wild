...
contract LUFTCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LUFTCoin() {
        ...
        name = "LUFTCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LUFT";                                             // Set the symbol for display purposes (CHANGE THIS)
