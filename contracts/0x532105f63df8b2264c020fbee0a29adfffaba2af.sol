...
contract Luvtoken is StandardToken { // CHANGE THIS. Update the contract name.

    /* Public variables of the token */

    /*
    NOTE:*************************L U V T O K E N *****************************
    ********L U V T O K E N  **************L U V T O K E N  *****
...
*************REVOLUTIONIZING ROMANCE AND LOVE WITH BLOCKCHAIN TECHNOLOGY****************CREATED ON VALENTINES DAY 14/02/2018
   */
    ...
    function Luvtoken() {
        ...
        totalSupply = 200000000;                        // Update total supply (1000 for example) (L U V T O K E N )
        name = "Luvtoken";                                   // Set the name for display purposes (L U V T O K E N )
        decimals = 0;                                               // Amount of decimals for display purposes (L U V T O K E N )
        symbol = "LUV";                                             // Set the symbol for display purposes (L U V T O K E N )
