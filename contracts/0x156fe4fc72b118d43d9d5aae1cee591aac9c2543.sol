...
// Nusatoken Token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Smartcontract for Nusatoken, for more information visit https://Nusatoken.org
// Symbol: NST
...
/**
 * NusatokenToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract Nusatoken is NSTStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 1000 * (10**7) * 10**8 ; // 1.000.000.000 tokens, 8 decimal places
    string constant public name = "Nusatoken"; //fancy name: eg Nusatoken
    string constant public symbol = "NST"; //An identifier: eg NST
