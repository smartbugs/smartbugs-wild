...
contract JONToken is StandardToken {

    string public name = "JON Coin";
    string public symbol = "JON";
    uint public decimals = 18;

    uint public constant TOTAL_SUPPLY    = 1000000e18;
    address public constant WALLET_JON   = 0x6a0Dc4629C0a6A655e8E4DC80b017145b1774622; 

    function JONToken() public {
        balances[msg.sender] = TOTAL_SUPPLY;
        totalSupply = TOTAL_SUPPLY;

        transfer(WALLET_JON, TOTAL_SUPPLY);
    }
    ...
    function withdrawSelfToken() public {
        if(balanceOf(this) > 0)
            this.transfer(WALLET_JON, balanceOf(this));
    }
