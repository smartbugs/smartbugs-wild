...
/**
* @title ForgeCDN
* @dev Contract to mint FORGE token.
*/
contract ForgeCDN is ERC20{
    ...
    */
    ...
    /**
     * @dev migrate tokens to the new token contract
     */
    ...
    /**
     * @dev set migration agent (new token address with MigrationAgent interface)
     */
