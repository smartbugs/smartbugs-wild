...
contract FAIZACOIN is StandardToken {
    ...
    */
    string public name = 'FAIZACOIN';                   //fancy name: eg Simon Bucks
    ...
    string public symbol = 'FZC';                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function FAIZACOIN(
        ...
        name = "FAIZA Coin";                            // Set the name for display purposes
        decimals = 0;                                 // Amount of decimals for display purposes
        symbol = "FZC";                               // Set the symbol for display purposes
    }
