...
contract PoHMO4D is modularShort {
    ...
    uint256 constant private rndInc_ = 2 minutes;              // every full key purchased adds this much to the timer
...
//==============================================================================
        ...
        public
    {
        ...
        fees_[0] = F3Ddatasets.TeamFee(60,0);   // NO P3D SHARES
        ...
        // (F3D, P3D)
        potSplit_[0] = F3Ddatasets.PotSplit(15,0);  //15% to next round
        potSplit_[1] = F3Ddatasets.PotSplit(10,0);   //10% to next round
        potSplit_[2] = F3Ddatasets.PotSplit(5,0);  //5% to next round
        potSplit_[3] = F3Ddatasets.PotSplit(7,0);  //7%
	}
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
