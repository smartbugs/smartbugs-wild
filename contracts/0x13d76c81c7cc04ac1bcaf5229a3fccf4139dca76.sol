...
contract CoinHb // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0xDc821453943366A39D7A591fB2e5223a5270AD7c; // @eachvar
    address public account_address = 0xDc821453943366A39D7A591fB2e5223a5270AD7c; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "H token"; // @eachvar
    string public symbol = "HB"; // @eachvar
    ...
    uint256 public direct_drop_rate = 5000; // 兑换比例，注意这里是eth为单位，需要换算到wei @eachvar
    address public direct_drop_address = 0xb4C08065eBE4E42396f77A2b335F09038e94fA2D; // 用于发放直投代币的账户 @eachvar
    address public direct_drop_withdraw_address = 0xb4C08065eBE4E42396f77A2b335F09038e94fA2D; // 直投提现地址 @eachvar

    bool public direct_drop_range = false; // 是否启用直投有效期 @eachvar
    uint256 public direct_drop_range_start = 1542628500; // 有效期开始 @eachvar
    uint256 public direct_drop_range_end = 1574164500; // 有效期结束 @eachvar
    ...
    uint256 public air_drop_rate = 10; // 赠送的代币枚数，这个其实不是rate，直接是数量 @eachvar
    address public air_drop_address = 0x102f8cF3CfaaF0715596Adeca8684ba6FB7A3A83; // 用于发放空投代币的账户 @eachvar
    ...
    uint256 public air_drop_range_start = 1542628500; // 有效期开始 @eachvar
    uint256 public air_drop_range_end = 1574164500; // 有效期结束 @eachvar
