...
contract LiveCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LiveCoin() {
        ...
        name = "LiveCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LEC";                                             // Set the symbol for display purposes (CHANGE THIS)
