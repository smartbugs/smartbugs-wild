...
contract P4RTYToken is MintableToken {
    ...
    string public constant symbol = "P4RTY"; // solium-disable-line uppercase
    ...
    /**
     * @dev Legal disclaimer/agreement associated with token
     * @param legal Address of the legal contract
     */
