...
contract Aurora_v1 is StandardToken {
    ...
    */
    string public name = "Aurora_v1";
    string public symbol = "AV1au";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 500 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/03b102faa1ce1cb5ce19b7ff18fdb817762f57cd0acc864bfff67d42bdb0ec0b/";
    string public Note_root = "";
    string public DigestCode_root = "95312ecf2d8d81804a58169586966fd175eed82aacbcd88678aa001abe8e905c";
    function getIssuer() public view returns(string) { return  "aurora"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/9e37a1f856af071ceb1b8ccf4ed1f5a246e33b390e13b084ad968adfe2ba662f/"; }
