...
/**
 * @title Standard + Mintable + Burnable ERC20 token
 *
 * @dev Implementation of the basic standard token with function of minting and burn
...
contract MasToken is StandardMintableBurnableToken {
  ...
  string public name = "Mainasset Token";
