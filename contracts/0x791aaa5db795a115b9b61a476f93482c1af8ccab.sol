...
/**
*
* Get your 8,88% every day profit with MMM8 Contract!
* New MMM in action!
* With the refusal of ownership, without KRO, without the human factor, on the most reliable blockchain in the world!
* Only 2% for technical support and 3% for advertising!
* The remaining 95% remain in the contract fund!
* The world has never seen anything like it!
* Together We Can Much and Only Together We Change the World!
*/
...
Percent.percent private m_adminsPercent = Percent.percent(2,100);          //  2/100 *100% = 2.0%
Percent.percent private m_advertisingPercent = Percent.percent(3,100);    //  3/100 *100% = 3.0%
