...
contract UnionBankOfSwitzerland is StandardToken { // Token is Geo-spatially coded ECR20 Contract.
    ...
    */
    ...
    function UnionBankOfSwitzerland() {
        ...
        name = "UBS Union Bank of Switzerland Certified Deposit- UBS Trustees (Bahamas) Ltd- UBS Headquarters- Basel Switzerland";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "USDollar";                                             // Set the symbol for display purposes (CHANGE THIS)
