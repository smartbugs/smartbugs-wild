...
contract SpectraCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SpectraCoin() {
        ...
        name = "SpectraCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SPEC";                                             // Set the symbol for display purposes (CHANGE THIS)
