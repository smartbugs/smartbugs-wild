...
contract BPRchain is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BPRchain() {
        ...
        name = "BPRchain";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BPR";                                             // Set the symbol for display purposes (CHANGE THIS)
